...
public class VEZombieDemonPlushBlock extends VEZombiePlushBlock
{
    ...
    protected static final VoxelShape ZOMBIE_DEMON_SOUTH_SHAPE = VEBoxBlockUtil.rotate180(Axis.Y,
            ZOMBIE_DEMON_NORTH_SHAPE);
    protected static final VoxelShape ZOMBIE_DEMON_WEST_SHAPE = VEBoxBlockUtil.rotate270(Axis.Y,
            ZOMBIE_DEMON_NORTH_SHAPE);
    protected static final VoxelShape ZOMBIE_DEMON_EAST_SHAPE = VEBoxBlockUtil.rotate90(Axis.Y,
            ZOMBIE_DEMON_NORTH_SHAPE);
