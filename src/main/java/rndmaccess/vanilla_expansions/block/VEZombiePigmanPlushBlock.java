...
public class VEZombiePigmanPlushBlock extends VEZombiePlushBlock
{
    ...
    protected static final VoxelShape ZOMBIE_PIGMAN_WEST_SHAPE = VEBoxBlockUtil.rotate270(Axis.Y,
            ZOMBIE_PIGMAN_NORTH_SHAPE);
    protected static final VoxelShape ZOMBIE_PIGMAN_EAST_SHAPE = VEBoxBlockUtil.rotate90(Axis.Y,
            ZOMBIE_PIGMAN_NORTH_SHAPE);
