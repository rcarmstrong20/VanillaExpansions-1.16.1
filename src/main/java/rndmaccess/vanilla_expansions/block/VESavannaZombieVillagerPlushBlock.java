...
public class VESavannaZombieVillagerPlushBlock extends VESavannaVillagerPlushBlock
{
    ...
    protected static final VoxelShape NORTH_SHAPE = VoxelShapes.or(NORTH_FEET, NORTH_FACE, NORTH_BODY, NORTH_HEADBAND);
    ...
    public VESavannaZombieVillagerPlushBlock(Properties properties)
    {
        super(properties);
    }
