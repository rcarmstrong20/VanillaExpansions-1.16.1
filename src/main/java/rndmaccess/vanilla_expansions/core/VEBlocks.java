...
import rndmaccess.vanilla_expansions.block.VEBlazePlushBlock;
import rndmaccess.vanilla_expansions.block.VECatPlushBlock;
import rndmaccess.vanilla_expansions.block.VECattailBlock;
import rndmaccess.vanilla_expansions.block.VECaveSpiderPlushBlock;
import rndmaccess.vanilla_expansions.block.VEChickenPlushBlock;
...
import rndmaccess.vanilla_expansions.block.VEFlowingDarkMatterBlock;
import rndmaccess.vanilla_expansions.block.VEGhastPlushBlock;
import rndmaccess.vanilla_expansions.block.VEGrassSlabBlock;
import rndmaccess.vanilla_expansions.block.VEGuardianPlushBlock;
import rndmaccess.vanilla_expansions.block.VEHorsePlushBlock;
import rndmaccess.vanilla_expansions.block.VEHugePurpleMushroomBlock;
import rndmaccess.vanilla_expansions.block.VEIcicleBlock;
import rndmaccess.vanilla_expansions.block.VELadderBlock;
import rndmaccess.vanilla_expansions.block.VEMagmaCubePlushBlock;
import rndmaccess.vanilla_expansions.block.VEMooshroomPlushBlock;
import rndmaccess.vanilla_expansions.block.VEMushroomBlock;
import rndmaccess.vanilla_expansions.block.VEOreBlock;
import rndmaccess.vanilla_expansions.block.VEPersianCatPlushBlock;
import rndmaccess.vanilla_expansions.block.VEPigPlushBlock;
import rndmaccess.vanilla_expansions.block.VEPlanterBoxBlock;
...
public class VEBlocks
{
    ...
    public static Block enderHorsePlush = register("ender_horse_plush", true,
            new VEHorsePlushBlock(buildProperties(VEMaterialType.WOOL, MaterialColor.COLOR_PURPLE).strength(0.2F)));
    ...
    public static Block purpleSheepPlush = register("purple_sheep_plush", true,
            new VESheepPlushBlock(AbstractBlock.Properties.copy(VEBlocks.enderHorsePlush)));
    ...
    public static Block witchPlush = register("witch_plush", true,
            new VEWitchPlushBlock(AbstractBlock.Properties.copy(VEBlocks.enderHorsePlush)));
