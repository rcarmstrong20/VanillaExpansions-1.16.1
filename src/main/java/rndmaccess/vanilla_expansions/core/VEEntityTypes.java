...
public class VEEntityTypes
{
    ...
    public static EntityType<VEEnderHorseEntity> enderHorse = register("ender_horse",
    ...
    public static EntityType<VECharredRemnantEntity> charredRemnant = register("charred_remnant", EntityType.Builder
            .of(VECharredRemnantEntity::new, EntityClassification.CREATURE).sized(0.6F, 1.95F).clientTrackingRange(8));
