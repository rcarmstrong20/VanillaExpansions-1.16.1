...
public class VeWoodcutterScreen extends ContainerScreen<VeWoodcutterContainer>
{
	...
	*/
	...
	protected void func_230450_a_(MatrixStack matrixStack, float partialTicks, int mouseX, int mouseY) //Same as drawGuiContainerBackgroundLayer
	{
		...
		this.func_238474_b_(matrixStack, i + 119, j + 15 + k, 176 + (this.canScroll() ? 0 : 12), 0, 12, 15); //Same as blit
	...
	public boolean func_231045_a_(double p_mouseDragged_1_, double p_mouseDragged_3_, int p_mouseDragged_5_, double p_mouseDragged_6_, double p_mouseDragged_8_)
	{
		...
		{
			return super.func_231045_a_(p_mouseDragged_1_, p_mouseDragged_3_, p_mouseDragged_5_, p_mouseDragged_6_, p_mouseDragged_8_); //Same as mouseDragged
		}
	}
