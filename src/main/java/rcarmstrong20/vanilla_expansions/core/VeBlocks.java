...
public class VeBlocks
{
	...
	public static Block warped_planting_pot = register("warped_planting_pot", true, new VePlantingPotBlock(AbstractBlock.Properties.from(Blocks.NETHER_BRICKS)));
	public static Block crimson_planting_pot = register("crimson_planting_pot", true, new VePlantingPotBlock(AbstractBlock.Properties.from(Blocks.NETHER_BRICKS)));
	...
	public static Block spruce_ladder = register("spruce_ladder", true, new VeLadderBlock(AbstractBlock.Properties.from(Blocks.LADDER)));
	public static Block birch_ladder = register("birch_ladder", true, new VeLadderBlock(AbstractBlock.Properties.from(Blocks.LADDER)));
	public static Block jungle_ladder = register("jungle_ladder", true, new VeLadderBlock(AbstractBlock.Properties.from(Blocks.LADDER)));
	public static Block acacia_ladder = register("acacia_ladder", true, new VeLadderBlock(AbstractBlock.Properties.from(Blocks.LADDER)));
	public static Block dark_oak_ladder = register("dark_oak_ladder", true, new VeLadderBlock(AbstractBlock.Properties.from(Blocks.LADDER)));
	public static Block warped_ladder = register("warped_ladder", true, new VeLadderBlock(AbstractBlock.Properties.from(Blocks.LADDER)));
	public static Block crimson_ladder = register("crimson_ladder", true, new VeLadderBlock(AbstractBlock.Properties.from(Blocks.LADDER)));
	public static Block iron_ladder = register("iron_ladder", true, new VeLadderBlock(AbstractBlock.Properties.create(Material.IRON, MaterialColor.IRON).hardnessAndResistance(0.4F, 5.0F).sound(SoundType.METAL).notSolid()));
