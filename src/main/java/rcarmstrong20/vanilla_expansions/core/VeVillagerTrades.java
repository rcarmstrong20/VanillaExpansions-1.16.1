...
{
	public static final Int2ObjectMap<ITrade[]> LUMBERJACK_TRADES = getAsIntMap(ImmutableMap.of(1, new VillagerTrades.ITrade[] {itemForEmeraldTrade(new ItemStack(Items.APPLE),
			                                                                                                                                        16,
			                                                                                                                                        2),
                                                                                                                                itemForEmeraldTrade(new ItemStack(VeItems.spruce_cone),
                                                                                                                                		            10,
                                                                                                                                		            2)},
                                                                                                2, new VillagerTrades.ITrade[] {new BasicTrade(2,
                                                                                                                                ...
                                                                                                                                new BasicTrade(3,
                                                                                                                                		       ...
                                                                                                                                		       15,
                                                                                                                                		       0.02F)},
                                                                                                3, new VillagerTrades.ITrade[] {convertItemForEmeraldTrade(new ItemStack(Blocks.OAK_LOG,
                                                                                                	                                                                     5),
                                                                                                                                                           new ItemStack(Items.CHARCOAL,
                                                                                                                                                                         5),
                                                                                                                                                           5,
                                                                                                                                                           15),
                                                                                                                                convertItemForEmeraldTrade(new ItemStack(Blocks.BIRCH_LOG,
                                                                                                                                                                         5),
                                                                                                                                                           new ItemStack(Items.CHARCOAL,
                                                                                                                                                                         5),
                                                                                                                                                           5,
                                                                                                                                                           15),
                                                                                                                                convertItemForEmeraldTrade(new ItemStack(Blocks.JUNGLE_LOG,
                                                                                                                                                                         5),
                                                                                                                                                           new ItemStack(Items.CHARCOAL,
                                                                                                                                                                         5),
                                                                                                                                                           5,
                                                                                                                                                           15),
                                                                                                                                convertItemForEmeraldTrade(new ItemStack(Blocks.ACACIA_LOG,
                                                                                                                                                                         5),
                                                                                                                                                           new ItemStack(Items.CHARCOAL,
                                                                                                                                                                         5),
                                                                                                                                                           5,
                                                                                                                                                           15),
                                                                                                                                convertItemForEmeraldTrade(new ItemStack(Blocks.DARK_OAK_LOG,
                                                                                                                                                                         5),
                                                                                                                                                           new ItemStack(Items.CHARCOAL,
                                                                                                                                                                         5),
                                                                                                                                                           5,
                                                                                                                                                           15)},
                                                                                                4, new VillagerTrades.ITrade[] {new BasicTrade(1,
                                                                                                                                ...
                                                                                                                                new BasicTrade(1,
                                                                                                                                               ...
                                                                                                                                               20,
                                                                                                                                               0.05F)},
                                                                                                5, new VillagerTrades.ITrade[] {masterTrade(1,
                                                                                                                                            new ItemStack(Blocks.NOTE_BLOCK),
                                                                                                                                            10,
                                                                                                                                            0.05F),
                                                                                                                                masterTrade(5,
	...
	/**
	 * Create villager trades that convert a material and emerald to make a new item. Example, wood -> coal.
	 * 
