...
public class VeTileEntityType
{
	...
	public static TileEntityType<VeColoredCampfireTileEntity> colored_campfire = register("colored_campfire", TileEntityType.Builder.create(VeColoredCampfireTileEntity::new,
																																			VeBlocks.white_campfire,
																																			VeBlocks.orange_campfire,
	...
	public static TileEntityType<VeFrameTileEntity> frame = register("frame", TileEntityType.Builder.create(VeFrameTileEntity::new,
																											VeBlocks.oak_frame,
																											VeBlocks.spruce_frame,
																											VeBlocks.birch_frame,
																											VeBlocks.jungle_frame,
																											VeBlocks.acacia_frame,
																											VeBlocks.dark_oak_frame,
																											VeBlocks.warped_frame,
																											VeBlocks.crimson_frame));
	
	/**
	 * @param <T>     An instance of the TileEntity class.
	 * @param name    The name of the tile entity type.
	 * @param builder A new instance of TileEntityType.Builder<T> for the tile entity type.
