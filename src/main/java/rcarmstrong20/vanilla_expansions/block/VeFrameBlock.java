...
public class VeFrameBlock extends ContainerBlock implements IWaterLoggable
{
    ...
    private static final VoxelShape FRAME_NORTH_BACK_SHAPE = Block.makeCuboidShape(0.0D, 0.0D, 15.0D, 16.0D, 16.0D,
            16.0D);
    private static final VoxelShape FRAME_NORTH_RIGHT_SHAPE = Block.makeCuboidShape(0.0D, 0.0D, 14.0D, 1.0D, 16.0D,
            15.0D);
    private static final VoxelShape FRAME_NORTH_LEFT_SHAPE = Block.makeCuboidShape(15.0D, 0.0D, 14.0D, 16.0D, 16.0D,
            15.0D);
    private static final VoxelShape FRAME_NORTH_TOP_SHAPE = Block.makeCuboidShape(0.0D, 15.0D, 14.0D, 16.0D, 16.0D,
            15.0D);
    private static final VoxelShape FRAME_NORTH_BOTTOM_SHAPE = Block.makeCuboidShape(0.0D, 0.0D, 14.0D, 16.0D, 1.0D,
            15.0D);
    ...
    private static final VoxelShape FRAME_NORTH_TOP_AND_RIGHT_RIM_SHAPE = VoxelShapes.or(FRAME_NORTH_BACK_SHAPE,
            FRAME_NORTH_TOP_SHAPE, FRAME_NORTH_RIGHT_SHAPE);

    private static final VoxelShape FRAME_NORTH_TOP_AND_LEFT_RIM_SHAPE = VoxelShapes.or(FRAME_NORTH_BACK_SHAPE,
            FRAME_NORTH_TOP_SHAPE, FRAME_NORTH_LEFT_SHAPE);

    private static final VoxelShape FRAME_NORTH_BOTTOM_AND_RIGHT_RIM_SHAPE = VoxelShapes.or(FRAME_NORTH_BACK_SHAPE,
            FRAME_NORTH_BOTTOM_SHAPE, FRAME_NORTH_RIGHT_SHAPE);

    private static final VoxelShape FRAME_NORTH_BOTTOM_AND_LEFT_RIM_SHAPE = VoxelShapes.or(FRAME_NORTH_BACK_SHAPE,
            FRAME_NORTH_BOTTOM_SHAPE, FRAME_NORTH_LEFT_SHAPE);

    private static final VoxelShape FRAME_NORTH_RIGHT_AND_LEFT_RIM_SHAPE = VoxelShapes.or(FRAME_NORTH_BACK_SHAPE,
            FRAME_NORTH_RIGHT_SHAPE, FRAME_NORTH_LEFT_SHAPE);

    private static final VoxelShape FRAME_NORTH_TOP_AND_BOTTOM_RIM_SHAPE = VoxelShapes.or(FRAME_NORTH_BACK_SHAPE,
            FRAME_NORTH_TOP_SHAPE, FRAME_NORTH_BOTTOM_SHAPE);

    private static final VoxelShape FRAME_NORTH_TOP_LEFT_AND_RIGHT_RIM_SHAPE = VoxelShapes.or(FRAME_NORTH_BACK_SHAPE,
            FRAME_NORTH_TOP_SHAPE, FRAME_NORTH_RIGHT_SHAPE, FRAME_NORTH_LEFT_SHAPE);

    private static final VoxelShape FRAME_NORTH_BOTTOM_LEFT_AND_RIGHT_RIM_SHAPE = VoxelShapes.or(FRAME_NORTH_BACK_SHAPE,
            FRAME_NORTH_BOTTOM_SHAPE, FRAME_NORTH_RIGHT_SHAPE, FRAME_NORTH_LEFT_SHAPE);

    private static final VoxelShape FRAME_NORTH_TOP_BOTTOM_AND_LEFT_RIM_SHAPE = VoxelShapes.or(FRAME_NORTH_BACK_SHAPE,
            FRAME_NORTH_TOP_SHAPE, FRAME_NORTH_BOTTOM_SHAPE, FRAME_NORTH_LEFT_SHAPE);

    private static final VoxelShape FRAME_NORTH_TOP_BOTTOM_AND_RIGHT_RIM_SHAPE = VoxelShapes.or(FRAME_NORTH_BACK_SHAPE,
            FRAME_NORTH_TOP_SHAPE, FRAME_NORTH_BOTTOM_SHAPE, FRAME_NORTH_RIGHT_SHAPE);

    private static final VoxelShape FRAME_NORTH_ALL_SHAPE = VoxelShapes.or(FRAME_NORTH_BACK_SHAPE,
            FRAME_NORTH_RIGHT_SHAPE, FRAME_NORTH_LEFT_SHAPE, FRAME_NORTH_TOP_SHAPE, FRAME_NORTH_BOTTOM_SHAPE);

    private static final VoxelShape FRAME_SOUTH_TOP_RIM_SHAPE = VeCollisionUtil.rotate180(Axis.Y,
            FRAME_NORTH_TOP_RIM_SHAPE);
    private static final VoxelShape FRAME_SOUTH_BOTTOM_RIM_SHAPE = VeCollisionUtil.rotate180(Axis.Y,
            FRAME_NORTH_BOTTOM_RIM_SHAPE);
    private static final VoxelShape FRAME_SOUTH_RIGHT_RIM_SHAPE = VeCollisionUtil.rotate180(Axis.Y,
            FRAME_NORTH_RIGHT_RIM_SHAPE);
    private static final VoxelShape FRAME_SOUTH_LEFT_RIM_SHAPE = VeCollisionUtil.rotate180(Axis.Y,
            FRAME_NORTH_LEFT_RIM_SHAPE);
    private static final VoxelShape FRAME_SOUTH_TOP_AND_RIGHT_RIM_SHAPE = VeCollisionUtil.rotate180(Axis.Y,
            FRAME_NORTH_TOP_AND_RIGHT_RIM_SHAPE);
    private static final VoxelShape FRAME_SOUTH_TOP_AND_LEFT_RIM_SHAPE = VeCollisionUtil.rotate180(Axis.Y,
            FRAME_NORTH_TOP_AND_LEFT_RIM_SHAPE);
    private static final VoxelShape FRAME_SOUTH_BOTTOM_AND_RIGHT_RIM_SHAPE = VeCollisionUtil.rotate180(Axis.Y,
            FRAME_NORTH_BOTTOM_AND_RIGHT_RIM_SHAPE);
    private static final VoxelShape FRAME_SOUTH_BOTTOM_AND_LEFT_RIM_SHAPE = VeCollisionUtil.rotate180(Axis.Y,
            FRAME_NORTH_BOTTOM_AND_LEFT_RIM_SHAPE);
    private static final VoxelShape FRAME_SOUTH_RIGHT_AND_LEFT_RIM_SHAPE = VeCollisionUtil.rotate180(Axis.Y,
            FRAME_NORTH_RIGHT_AND_LEFT_RIM_SHAPE);
    private static final VoxelShape FRAME_SOUTH_TOP_AND_BOTTOM_RIM_SHAPE = VeCollisionUtil.rotate180(Axis.Y,
            FRAME_NORTH_TOP_AND_BOTTOM_RIM_SHAPE);
    private static final VoxelShape FRAME_SOUTH_TOP_LEFT_AND_RIGHT_RIM_SHAPE = VeCollisionUtil.rotate180(Axis.Y,
            FRAME_NORTH_TOP_LEFT_AND_RIGHT_RIM_SHAPE);
    private static final VoxelShape FRAME_SOUTH_BOTTOM_LEFT_AND_RIGHT_RIM_SHAPE = VeCollisionUtil.rotate180(Axis.Y,
            FRAME_NORTH_BOTTOM_LEFT_AND_RIGHT_RIM_SHAPE);
    private static final VoxelShape FRAME_SOUTH_TOP_BOTTOM_AND_LEFT_RIM_SHAPE = VeCollisionUtil.rotate180(Axis.Y,
            FRAME_NORTH_TOP_BOTTOM_AND_LEFT_RIM_SHAPE);
    private static final VoxelShape FRAME_SOUTH_TOP_BOTTOM_AND_RIGHT_RIM_SHAPE = VeCollisionUtil.rotate180(Axis.Y,
    ...
    private static final VoxelShape FRAME_WEST_TOP_RIM_SHAPE = VeCollisionUtil.rotate270(Axis.Y,
            FRAME_NORTH_TOP_RIM_SHAPE);
    private static final VoxelShape FRAME_WEST_BOTTOM_RIM_SHAPE = VeCollisionUtil.rotate270(Axis.Y,
            FRAME_NORTH_BOTTOM_RIM_SHAPE);
    private static final VoxelShape FRAME_WEST_RIGHT_RIM_SHAPE = VeCollisionUtil.rotate270(Axis.Y,
            FRAME_NORTH_RIGHT_RIM_SHAPE);
    private static final VoxelShape FRAME_WEST_LEFT_RIM_SHAPE = VeCollisionUtil.rotate270(Axis.Y,
            FRAME_NORTH_LEFT_RIM_SHAPE);
    private static final VoxelShape FRAME_WEST_TOP_AND_RIGHT_RIM_SHAPE = VeCollisionUtil.rotate270(Axis.Y,
            FRAME_NORTH_TOP_AND_RIGHT_RIM_SHAPE);
    private static final VoxelShape FRAME_WEST_TOP_AND_LEFT_RIM_SHAPE = VeCollisionUtil.rotate270(Axis.Y,
            FRAME_NORTH_TOP_AND_LEFT_RIM_SHAPE);
    private static final VoxelShape FRAME_WEST_BOTTOM_AND_RIGHT_RIM_SHAPE = VeCollisionUtil.rotate270(Axis.Y,
            FRAME_NORTH_BOTTOM_AND_RIGHT_RIM_SHAPE);
    private static final VoxelShape FRAME_WEST_BOTTOM_AND_LEFT_RIM_SHAPE = VeCollisionUtil.rotate270(Axis.Y,
            FRAME_NORTH_BOTTOM_AND_LEFT_RIM_SHAPE);
    private static final VoxelShape FRAME_WEST_RIGHT_AND_LEFT_RIM_SHAPE = VeCollisionUtil.rotate270(Axis.Y,
            FRAME_NORTH_RIGHT_AND_LEFT_RIM_SHAPE);
    private static final VoxelShape FRAME_WEST_TOP_AND_BOTTOM_RIM_SHAPE = VeCollisionUtil.rotate270(Axis.Y,
            FRAME_NORTH_TOP_AND_BOTTOM_RIM_SHAPE);
    private static final VoxelShape FRAME_WEST_TOP_LEFT_AND_RIGHT_RIM_SHAPE = VeCollisionUtil.rotate270(Axis.Y,
            FRAME_NORTH_TOP_LEFT_AND_RIGHT_RIM_SHAPE);
    private static final VoxelShape FRAME_WEST_BOTTOM_LEFT_AND_RIGHT_RIM_SHAPE = VeCollisionUtil.rotate270(Axis.Y,
            FRAME_NORTH_BOTTOM_LEFT_AND_RIGHT_RIM_SHAPE);
    private static final VoxelShape FRAME_WEST_TOP_BOTTOM_AND_LEFT_RIM_SHAPE = VeCollisionUtil.rotate270(Axis.Y,
            FRAME_NORTH_TOP_BOTTOM_AND_LEFT_RIM_SHAPE);
    private static final VoxelShape FRAME_WEST_TOP_BOTTOM_AND_RIGHT_RIM_SHAPE = VeCollisionUtil.rotate270(Axis.Y,
            FRAME_NORTH_TOP_BOTTOM_AND_RIGHT_RIM_SHAPE);
    ...
    private static final VoxelShape FRAME_EAST_TOP_RIM_SHAPE = VeCollisionUtil.rotate90(Axis.Y,
            FRAME_NORTH_TOP_RIM_SHAPE);
    private static final VoxelShape FRAME_EAST_BOTTOM_RIM_SHAPE = VeCollisionUtil.rotate90(Axis.Y,
            FRAME_NORTH_BOTTOM_RIM_SHAPE);
    private static final VoxelShape FRAME_EAST_RIGHT_RIM_SHAPE = VeCollisionUtil.rotate90(Axis.Y,
            FRAME_NORTH_RIGHT_RIM_SHAPE);
    private static final VoxelShape FRAME_EAST_LEFT_RIM_SHAPE = VeCollisionUtil.rotate90(Axis.Y,
            FRAME_NORTH_LEFT_RIM_SHAPE);
    private static final VoxelShape FRAME_EAST_TOP_AND_RIGHT_RIM_SHAPE = VeCollisionUtil.rotate90(Axis.Y,
            FRAME_NORTH_TOP_AND_RIGHT_RIM_SHAPE);
    private static final VoxelShape FRAME_EAST_TOP_AND_LEFT_RIM_SHAPE = VeCollisionUtil.rotate90(Axis.Y,
            FRAME_NORTH_TOP_AND_LEFT_RIM_SHAPE);
    private static final VoxelShape FRAME_EAST_BOTTOM_AND_RIGHT_RIM_SHAPE = VeCollisionUtil.rotate90(Axis.Y,
            FRAME_NORTH_BOTTOM_AND_RIGHT_RIM_SHAPE);
    private static final VoxelShape FRAME_EAST_BOTTOM_AND_LEFT_RIM_SHAPE = VeCollisionUtil.rotate90(Axis.Y,
            FRAME_NORTH_BOTTOM_AND_LEFT_RIM_SHAPE);
    private static final VoxelShape FRAME_EAST_RIGHT_AND_LEFT_RIM_SHAPE = VeCollisionUtil.rotate90(Axis.Y,
            FRAME_NORTH_RIGHT_AND_LEFT_RIM_SHAPE);
    private static final VoxelShape FRAME_EAST_TOP_AND_BOTTOM_RIM_SHAPE = VeCollisionUtil.rotate90(Axis.Y,
            FRAME_NORTH_TOP_AND_BOTTOM_RIM_SHAPE);
    private static final VoxelShape FRAME_EAST_TOP_LEFT_AND_RIGHT_RIM_SHAPE = VeCollisionUtil.rotate90(Axis.Y,
            FRAME_NORTH_TOP_LEFT_AND_RIGHT_RIM_SHAPE);
    private static final VoxelShape FRAME_EAST_BOTTOM_LEFT_AND_RIGHT_RIM_SHAPE = VeCollisionUtil.rotate90(Axis.Y,
            FRAME_NORTH_BOTTOM_LEFT_AND_RIGHT_RIM_SHAPE);
    private static final VoxelShape FRAME_EAST_TOP_BOTTOM_AND_LEFT_RIM_SHAPE = VeCollisionUtil.rotate90(Axis.Y,
            FRAME_NORTH_TOP_BOTTOM_AND_LEFT_RIM_SHAPE);
    private static final VoxelShape FRAME_EAST_TOP_BOTTOM_AND_RIGHT_RIM_SHAPE = VeCollisionUtil.rotate90(Axis.Y,
            FRAME_NORTH_TOP_BOTTOM_AND_RIGHT_RIM_SHAPE);
    ...
    public VeFrameBlock(Properties properties)
    {
        ...
        this.setDefaultState(this.stateContainer.getBaseState().with(FACING, Direction.NORTH)
                .with(WATERLOGGED, Boolean.valueOf(false)).with(NORTH, false).with(SOUTH, false).with(WEST, false)
            ...
            Hand handIn, BlockRayTraceResult rayTrace)
    {
        ...
        if (!world.isRemote)
        {
            ...
            {
                // Place from bottom.
                if (VeTwoBlockPainting.addPaintingParts(world, pos, topPos, VeTwoBlockPainting.getBottomPaintingMap(),
                        VeTwoBlockPainting.getTopPaintingMap(), heldItem))
                {
                    return ActionResultType.SUCCESS;
                }
                // Place from top.
                if (VeTwoBlockPainting.addPaintingParts(world, pos, bottomPos, VeTwoBlockPainting.getTopPaintingMap(),
                        VeTwoBlockPainting.getBottomPaintingMap(), heldItem))
                {
                    return ActionResultType.SUCCESS;
                }
            }
                    ...
                    || VeTwoBlockPainting.getLeftPaintingMap().containsKey(heldItem.getItem()))
            {
                ...
                if (VeTwoBlockPainting.addPaintingParts(world, pos, westPos, VeTwoBlockPainting.getLeftPaintingMap(),
                        VeTwoBlockPainting.getRightPaintingMap(), heldItem))
                {
                    return ActionResultType.SUCCESS;
                }

                // Place from facing=south left or facing=north right.
                if (VeTwoBlockPainting.addPaintingParts(world, pos, eastPos, VeTwoBlockPainting.getRightPaintingMap(),
                        VeTwoBlockPainting.getLeftPaintingMap(), heldItem))
                {
                    return ActionResultType.SUCCESS;
                }
                // Place from facing=east left or facing=west right.
                if (VeTwoBlockPainting.addPaintingParts(world, pos, northPos, VeTwoBlockPainting.getLeftPaintingMap(),
                        VeTwoBlockPainting.getRightPaintingMap(), heldItem))
                {
                    return ActionResultType.SUCCESS;
                }
                // Place from facing=east right or facing=west left.
                if (VeTwoBlockPainting.addPaintingParts(world, pos, southPos, VeTwoBlockPainting.getRightPaintingMap(),
                        VeTwoBlockPainting.getLeftPaintingMap(), heldItem))
                {
                    return ActionResultType.SUCCESS;
                }
                    ...
                    || VeFourBlockPainting.getTopLeftPaintingMap().containsKey(heldItem.getItem()))
            {
                ...
                if (VeFourBlockPainting.addPaintingParts(world, pos, bottomPos, eastPos, bottomEastPos,
                        VeFourBlockPainting.getTopRightPaintingMap(), VeFourBlockPainting.getBottomRightPaintingMap(),
                        VeFourBlockPainting.getTopLeftPaintingMap(), VeFourBlockPainting.getBottomLeftPaintingMap(),
                        heldItem))
                {
                    return ActionResultType.SUCCESS;
                }
                // Place from facing=south bottom left or facing=north bottom right.
                if (VeFourBlockPainting.addPaintingParts(world, pos, topPos, eastPos, topEastPos,
                        VeFourBlockPainting.getBottomRightPaintingMap(), VeFourBlockPainting.getTopRightPaintingMap(),
                        VeFourBlockPainting.getBottomLeftPaintingMap(), VeFourBlockPainting.getTopLeftPaintingMap(),
                        heldItem))
                {
                    return ActionResultType.SUCCESS;
                }
                // Place from facing=south top right or facing=north or facing=north top left.
                if (VeFourBlockPainting.addPaintingParts(world, pos, bottomPos, westPos, bottomWestPos,
                        VeFourBlockPainting.getTopLeftPaintingMap(), VeFourBlockPainting.getBottomLeftPaintingMap(),
                        VeFourBlockPainting.getTopRightPaintingMap(), VeFourBlockPainting.getBottomRightPaintingMap(),
                        heldItem))
                {
                ...
                if (VeFourBlockPainting.addPaintingParts(world, pos, topPos, westPos, topWestPos,
                        VeFourBlockPainting.getBottomLeftPaintingMap(), VeFourBlockPainting.getTopLeftPaintingMap(),
                        VeFourBlockPainting.getBottomRightPaintingMap(), VeFourBlockPainting.getTopRightPaintingMap(),
                        heldItem))
                {
                ...
                if (VeFourBlockPainting.addPaintingParts(world, pos, bottomPos, northPos, bottomNorthPos,
                        VeFourBlockPainting.getTopLeftPaintingMap(), VeFourBlockPainting.getBottomLeftPaintingMap(),
                        VeFourBlockPainting.getTopRightPaintingMap(), VeFourBlockPainting.getBottomRightPaintingMap(),
                        heldItem))
                {
                ...
                if (VeFourBlockPainting.addPaintingParts(world, pos, topPos, northPos, topNorthPos,
                        VeFourBlockPainting.getBottomLeftPaintingMap(), VeFourBlockPainting.getTopLeftPaintingMap(),
                        VeFourBlockPainting.getBottomRightPaintingMap(), VeFourBlockPainting.getTopRightPaintingMap(),
                        heldItem))
                {
                ...
                if (VeFourBlockPainting.addPaintingParts(world, pos, bottomPos, southPos, bottomSouthPos,
                        VeFourBlockPainting.getTopRightPaintingMap(), VeFourBlockPainting.getBottomRightPaintingMap(),
                        VeFourBlockPainting.getTopLeftPaintingMap(), VeFourBlockPainting.getBottomLeftPaintingMap(),
                        heldItem))
                {
                ...
                if (VeFourBlockPainting.addPaintingParts(world, pos, topPos, southPos, topSouthPos,
                        VeFourBlockPainting.getBottomRightPaintingMap(), VeFourBlockPainting.getTopRightPaintingMap(),
                        VeFourBlockPainting.getBottomLeftPaintingMap(), VeFourBlockPainting.getTopLeftPaintingMap(),
                        heldItem))
                {
     ...
     * )) ||
     * VeEightBlockPainting.getBottomRightMiddlePaintingMap().containsKey(heldItem.
     * getItem()) ||
     * VeEightBlockPainting.getBottomRightPaintingMap().containsKey(heldItem.getItem
     * ()) ||
     * VeEightBlockPainting.getTopLeftMiddlePaintingMap().containsKey(heldItem.
     * getItem()) ||
     * VeEightBlockPainting.getTopLeftPaintingMap().containsKey(heldItem.getItem())
     * || VeEightBlockPainting.getTopRightMiddlePaintingMap().containsKey(heldItem.
     * getItem()) ||
     * VeEightBlockPainting.getTopRightPaintingMap().containsKey(heldItem.getItem())
     * ) { //Place the painting from top west to bottom east. if(bottomTileEntity
     * instanceof VeFrameTileEntity && eastTileEntity instanceof VeFrameTileEntity
     * && east2TileEntity instanceof VeFrameTileEntity && east3TileEntity instanceof
     * VeFrameTileEntity && bottomEastTileEntity instanceof VeFrameTileEntity &&
     * bottomEast2TileEntity instanceof VeFrameTileEntity && bottomEast3TileEntity
     * instanceof VeFrameTileEntity) { VeFrameTileEntity bottomFrame =
     * (VeFrameTileEntity) bottomTileEntity; VeFrameTileEntity eastFrame =
     * (VeFrameTileEntity) eastTileEntity; VeFrameTileEntity east2Frame =
     * (VeFrameTileEntity) east2TileEntity; VeFrameTileEntity east3Frame =
     * (VeFrameTileEntity) east3TileEntity; VeFrameTileEntity bottomEastFrame =
     ...
     * bottomEastFrame, bottomEast2Frame, bottomEast3Frame)) {
     * if(clickedFrame.addItem(new
     * ItemStack(VeEightBlockPainting.getTopRightPaintingMap().get(heldItem.getItem(
     * )))) && bottomFrame.addItem(new
     * ItemStack(VeEightBlockPainting.getBottomRightPaintingMap().get(heldItem.
     * getItem()))) && eastFrame.addItem(new
     * ItemStack(VeEightBlockPainting.getTopRightMiddlePaintingMap().get(heldItem.
     * getItem()))) && east2Frame.addItem(new
     * ItemStack(VeEightBlockPainting.getTopLeftMiddlePaintingMap().get(heldItem.
     * getItem()))) && east3Frame.addItem(new
     * ItemStack(VeEightBlockPainting.getTopLeftPaintingMap().get(heldItem.getItem()
     * ))) && bottomEastFrame.addItem(new
     * ItemStack(VeEightBlockPainting.getBottomRightMiddlePaintingMap().get(heldItem
     * .getItem()))) && bottomEast2Frame.addItem(new
     * ItemStack(VeEightBlockPainting.getBottomLeftMiddlePaintingMap().get(heldItem.
     * getItem()))) && bottomEast3Frame.addItem(new
     * ItemStack(VeEightBlockPainting.getBottomLeftPaintingMap().get(heldItem.
     ...
     * heldItem.shrink(1); return ActionResultType.SUCCESS; } } } //Place the
     * painting from bottom west to top east. if(topTileEntity instanceof
     * VeFrameTileEntity && eastTileEntity instanceof VeFrameTileEntity &&
     * east2TileEntity instanceof VeFrameTileEntity && east3TileEntity instanceof
     * VeFrameTileEntity && topEastTileEntity instanceof VeFrameTileEntity &&
     * topEast2TileEntity instanceof VeFrameTileEntity && topEast3TileEntity
     * instanceof VeFrameTileEntity) { VeFrameTileEntity topFrame =
     * (VeFrameTileEntity) topTileEntity; VeFrameTileEntity eastFrame =
     * (VeFrameTileEntity) eastTileEntity; VeFrameTileEntity east2Frame =
     * (VeFrameTileEntity) east2TileEntity; VeFrameTileEntity east3Frame =
     * (VeFrameTileEntity) east3TileEntity; VeFrameTileEntity topEastFrame =
     ...
     * topEast2Frame, topEast3Frame)) { if(clickedFrame.addItem(new
     * ItemStack(VeEightBlockPainting.getBottomRightPaintingMap().get(heldItem.
     * getItem()))) && topFrame.addItem(new
     * ItemStack(VeEightBlockPainting.getTopRightPaintingMap().get(heldItem.getItem(
     * )))) && eastFrame.addItem(new
     * ItemStack(VeEightBlockPainting.getBottomRightMiddlePaintingMap().get(heldItem
     * .getItem()))) && east2Frame.addItem(new
     * ItemStack(VeEightBlockPainting.getBottomLeftMiddlePaintingMap().get(heldItem.
     * getItem()))) && east3Frame.addItem(new
     * ItemStack(VeEightBlockPainting.getBottomLeftPaintingMap().get(heldItem.
     * getItem()))) && topEastFrame.addItem(new
     * ItemStack(VeEightBlockPainting.getTopRightMiddlePaintingMap().get(heldItem.
     * getItem()))) && topEast2Frame.addItem(new
     * ItemStack(VeEightBlockPainting.getTopLeftMiddlePaintingMap().get(heldItem.
     * getItem()))) && topEast3Frame.addItem(new
     * ItemStack(VeEightBlockPainting.getTopLeftPaintingMap().get(heldItem.getItem()
     * )))) { world.playSound(null, pos, SoundEvents.ENTITY_PAINTING_PLACE,
     * SoundCategory.BLOCKS, 1.0F, 0.8F + world.rand.nextFloat() * 0.4F);
     * heldItem.shrink(1); return ActionResultType.SUCCESS; } } } //Place the
     * painting from top west right middle. if(bottomTileEntity instanceof
     * VeFrameTileEntity && westTileEntity instanceof VeFrameTileEntity &&
     * eastTileEntity instanceof VeFrameTileEntity && east2TileEntity instanceof
     * VeFrameTileEntity && bottomWestTileEntity instanceof VeFrameTileEntity &&
     * bottomEastTileEntity instanceof VeFrameTileEntity && bottomEast2TileEntity
     * instanceof VeFrameTileEntity) { VeFrameTileEntity bottomFrame =
     * (VeFrameTileEntity) bottomTileEntity; VeFrameTileEntity westFrame =
     * (VeFrameTileEntity) westTileEntity; VeFrameTileEntity eastFrame =
     * (VeFrameTileEntity) eastTileEntity; VeFrameTileEntity east2Frame =
     * (VeFrameTileEntity) east2TileEntity; VeFrameTileEntity bottomWestFrame =
     ...
     * bottomEastFrame, bottomEast2Frame)) { if(clickedFrame.addItem(new
     * ItemStack(VeEightBlockPainting.getTopRightMiddlePaintingMap().get(heldItem.
     * getItem()))) && bottomFrame.addItem(new
     * ItemStack(VeEightBlockPainting.getBottomRightMiddlePaintingMap().get(heldItem
     * .getItem()))) && westFrame.addItem(new
     * ItemStack(VeEightBlockPainting.getTopRightPaintingMap().get(heldItem.getItem(
     * )))) && eastFrame.addItem(new
     * ItemStack(VeEightBlockPainting.getTopLeftMiddlePaintingMap().get(heldItem.
     * getItem()))) && east2Frame.addItem(new
     * ItemStack(VeEightBlockPainting.getTopLeftPaintingMap().get(heldItem.getItem()
     * ))) && bottomWestFrame.addItem(new
     * ItemStack(VeEightBlockPainting.getBottomRightPaintingMap().get(heldItem.
     * getItem()))) && bottomEastFrame.addItem(new
     * ItemStack(VeEightBlockPainting.getBottomLeftMiddlePaintingMap().get(heldItem.
     * getItem()))) && bottomEast2Frame.addItem(new
     * ItemStack(VeEightBlockPainting.getBottomLeftPaintingMap().get(heldItem.
     * getItem())))) { world.playSound(null, pos, SoundEvents.ENTITY_PAINTING_PLACE,
     ...
     * && eastTileEntity instanceof VeFrameTileEntity && east2TileEntity instanceof
     * VeFrameTileEntity && topWestTileEntity instanceof VeFrameTileEntity &&
     * topEastTileEntity instanceof VeFrameTileEntity && topEast2TileEntity
     * instanceof VeFrameTileEntity) { VeFrameTileEntity topFrame =
     * (VeFrameTileEntity) topTileEntity; VeFrameTileEntity westFrame =
     * (VeFrameTileEntity) westTileEntity; VeFrameTileEntity eastFrame =
     * (VeFrameTileEntity) eastTileEntity; VeFrameTileEntity east2Frame =
     * (VeFrameTileEntity) west2TileEntity; VeFrameTileEntity topWestFrame =
     ...
     * topEastFrame, topEast2Frame)) { if(clickedFrame.addItem(new
     * ItemStack(VeEightBlockPainting.getBottomRightMiddlePaintingMap().get(heldItem
     * .getItem()))) && topFrame.addItem(new
     * ItemStack(VeEightBlockPainting.getTopRightMiddlePaintingMap().get(heldItem.
     * getItem()))) && westFrame.addItem(new
     ...
     * getItem()))) && east2Frame.addItem(new
     * ItemStack(VeEightBlockPainting.getBottomLeftPaintingMap().get(heldItem.
     * getItem()))) && topWestFrame.addItem(new
     * ItemStack(VeEightBlockPainting.getTopRightPaintingMap().get(heldItem.getItem(
     * )))) && topEastFrame.addItem(new
     * ItemStack(VeEightBlockPainting.getTopLeftMiddlePaintingMap().get(heldItem.
     * getItem()))) && topEast2Frame.addItem(new
     * ItemStack(VeEightBlockPainting.getTopLeftPaintingMap().get(heldItem.getItem()
     * )))) { world.playSound(null, pos, SoundEvents.ENTITY_PAINTING_PLACE,
     ...
     * VeFrameTileEntity && bottomEastTileEntity instanceof VeFrameTileEntity &&
     * bottomWestTileEntity instanceof VeFrameTileEntity && bottomWest2TileEntity
     * instanceof VeFrameTileEntity) { VeFrameTileEntity bottomFrame =
     * (VeFrameTileEntity) bottomTileEntity; VeFrameTileEntity eastFrame =
     * (VeFrameTileEntity) eastTileEntity; VeFrameTileEntity westFrame =
     * (VeFrameTileEntity) westTileEntity; VeFrameTileEntity west2Frame =
     * (VeFrameTileEntity) west2TileEntity; VeFrameTileEntity bottomEastFrame =
     ...
     * bottomWestFrame, bottomWest2Frame)) { if(clickedFrame.addItem(new
     * ItemStack(VeEightBlockPainting.getTopLeftMiddlePaintingMap().get(heldItem.
     * getItem()))) && bottomFrame.addItem(new
     * ItemStack(VeEightBlockPainting.getBottomLeftMiddlePaintingMap().get(heldItem.
     * getItem()))) && eastFrame.addItem(new
     * ItemStack(VeEightBlockPainting.getTopLeftPaintingMap().get(heldItem.getItem()
     * ))) && westFrame.addItem(new
     * ItemStack(VeEightBlockPainting.getTopRightMiddlePaintingMap().get(heldItem.
     * getItem()))) && west2Frame.addItem(new
     * ItemStack(VeEightBlockPainting.getTopRightPaintingMap().get(heldItem.getItem(
     * )))) && bottomEastFrame.addItem(new
     * ItemStack(VeEightBlockPainting.getBottomLeftPaintingMap().get(heldItem.
     * getItem()))) && bottomWestFrame.addItem(new
     * ItemStack(VeEightBlockPainting.getBottomRightMiddlePaintingMap().get(heldItem
     * .getItem()))) && bottomWest2Frame.addItem(new
     * ItemStack(VeEightBlockPainting.getBottomRightPaintingMap().get(heldItem.
     * getItem())))) { world.playSound(null, pos, SoundEvents.ENTITY_PAINTING_PLACE,
     * SoundCategory.BLOCKS, 1.0F, 0.8F + world.rand.nextFloat() * 0.4F);
     * heldItem.shrink(1); return ActionResultType.SUCCESS; } } } } else
     ...
     * ActionResultType.CONSUME; } } return ActionResultType.FAIL; }
     */
    ...
    {
        world.playSound(null, clickedPos, SoundEvents.ENTITY_PAINTING_PLACE, SoundCategory.BLOCKS, 1.0F,
                0.8F + world.rand.nextFloat() * 0.4F);
        itemStack.shrink(1);
    }
            ...
            BlockPos currentPos, BlockPos facingPos)
    {
        ...
        else
        {
            return stateIn.with(UP, Boolean.valueOf(upFlag)).with(DOWN, Boolean.valueOf(downFlag))
                    ...
                    .with(SOUTH, Boolean.valueOf(southFlag)).with(WEST, Boolean.valueOf(westFlag));
        }
        return facingState;
    }
    ...
    public void onBlockHarvested(World world, BlockPos pos, BlockState state, PlayerEntity player)
    {
        ...
        Map<Item, Item> tallPaintingMap = (new Builder<Item, Item>())
                .put(VeItems.wanderer_painting_bottom, VeItems.wanderer_painting)
        ...
        Map<Item, Item> sidePaintingMap = (new Builder<Item, Item>())
                .put(VeItems.courbet_painting_right, VeItems.courbet_painting)
        ...
        Map<Item, Item> fourPaintingMap = (new Builder<Item, Item>())
                .put(VeItems.wither_painting_bottom_right, VeItems.wither_painting)
        ...
        if (tileEntity instanceof VeFrameTileEntity)
        {
            ...
            {
                List<Map<Item, Item>> topMapList = Arrays.asList(VeTwoBlockPainting.getTopPaintingMap(),
                        VeTwoBlockPainting.getBottomPaintingMap());
                List<Map<Item, Item>> bottomMapList = Arrays.asList(VeTwoBlockPainting.getBottomPaintingMap(),
                        VeTwoBlockPainting.getTopPaintingMap());

                // Harvest from bottom.
                harvestPainting(world, Arrays.asList(pos, topPos), bottomMapList);

                // Harvest from top.
                harvestPainting(world, Arrays.asList(pos, bottomPos), topMapList);
            ...
            else if (sidePaintingMap.containsKey(inventoryItem))
            {
                ...
                harvestPainting(world, Arrays.asList(pos, eastPos), Arrays
                        .asList(VeTwoBlockPainting.getRightPaintingMap(), VeTwoBlockPainting.getLeftPaintingMap()));

                // Harvest from x-axis left.
                harvestPainting(world, Arrays.asList(pos, westPos), Arrays
                        .asList(VeTwoBlockPainting.getLeftPaintingMap(), VeTwoBlockPainting.getRightPaintingMap()));

                // Harvest from z-axis right.
                harvestPainting(world, Arrays.asList(pos, southPos), Arrays
                        .asList(VeTwoBlockPainting.getRightPaintingMap(), VeTwoBlockPainting.getLeftPaintingMap()));

                // Harvest from z-axis left.
                harvestPainting(world, Arrays.asList(pos, northPos), Arrays
                        .asList(VeTwoBlockPainting.getLeftPaintingMap(), VeTwoBlockPainting.getRightPaintingMap()));
            ...
            else if (fourPaintingMap.containsKey(inventoryItem))
            {
                ...
                harvestPainting(world, Arrays.asList(pos, topPos, eastPos, topEastPos), Arrays.asList(
                        VeFourBlockPainting.getBottomRightPaintingMap(), VeFourBlockPainting.getTopRightPaintingMap(),
                        VeFourBlockPainting.getBottomLeftPaintingMap(), VeFourBlockPainting.getTopLeftPaintingMap()));

                // Harvest from x-axis bottom left.
                harvestPainting(world, Arrays.asList(pos, topPos, westPos, topWestPos), Arrays.asList(
                        VeFourBlockPainting.getBottomLeftPaintingMap(), VeFourBlockPainting.getTopLeftPaintingMap(),
                        VeFourBlockPainting.getBottomRightPaintingMap(), VeFourBlockPainting.getTopRightPaintingMap()));

                // Harvest from x-axis top left.
                harvestPainting(world, Arrays.asList(pos, bottomPos, westPos, bottomWestPos), Arrays.asList(
                        VeFourBlockPainting.getTopLeftPaintingMap(), VeFourBlockPainting.getBottomLeftPaintingMap(),
                        VeFourBlockPainting.getTopRightPaintingMap(), VeFourBlockPainting.getBottomRightPaintingMap()));

                // Harvest from z-axis top right.
                harvestPainting(world, Arrays.asList(pos, bottomPos, southPos, bottomSouthPos), Arrays.asList(
                        VeFourBlockPainting.getTopRightPaintingMap(), VeFourBlockPainting.getBottomRightPaintingMap(),
                        VeFourBlockPainting.getTopLeftPaintingMap(), VeFourBlockPainting.getBottomLeftPaintingMap()));

                // Harvest from z-axis bottom right.
                harvestPainting(world, Arrays.asList(pos, topPos, southPos, topSouthPos), Arrays.asList(
                        VeFourBlockPainting.getBottomRightPaintingMap(), VeFourBlockPainting.getTopRightPaintingMap(),
                        VeFourBlockPainting.getBottomLeftPaintingMap(), VeFourBlockPainting.getTopLeftPaintingMap()));

                // Harvest from z-axis top left.
                harvestPainting(world, Arrays.asList(pos, bottomPos, northPos, bottomNorthPos), Arrays.asList(
                        VeFourBlockPainting.getTopLeftPaintingMap(), VeFourBlockPainting.getBottomLeftPaintingMap(),
                        VeFourBlockPainting.getTopRightPaintingMap(), VeFourBlockPainting.getBottomRightPaintingMap()));

                // Harvest from z-axis bottom left.
                harvestPainting(world, Arrays.asList(pos, topPos, northPos, topNorthPos), Arrays.asList(
                        VeFourBlockPainting.getBottomLeftPaintingMap(), VeFourBlockPainting.getTopLeftPaintingMap(),
                        VeFourBlockPainting.getBottomRightPaintingMap(), VeFourBlockPainting.getTopRightPaintingMap()));
     ...
     * @return true if both blocks make up the painting that is currently being
     *         harvested otherwise return false.
     */
        ...
        if (posList.size() == paintingPartsMap.size())
        {
            ...
            for (int i = 0; i < posList.size(); i++)
            {
                ...
                if (currentTileEntity instanceof VeFrameTileEntity)
                {
                    ...
                    if (state.getBlock() == currentState.getBlock() && matchesFacing(state, currentState)
        ...
        switch (state.get(FACING))
        {
            case NORTH:
                return defineShapes(state, state.get(WEST), state.get(EAST), Direction.NORTH, FRAME_NORTH_TOP_RIM_SHAPE,
                        FRAME_NORTH_BOTTOM_RIM_SHAPE, FRAME_NORTH_RIGHT_RIM_SHAPE, FRAME_NORTH_LEFT_RIM_SHAPE,
                        FRAME_NORTH_TOP_AND_RIGHT_RIM_SHAPE, FRAME_NORTH_TOP_AND_LEFT_RIM_SHAPE,
                        FRAME_NORTH_BOTTOM_AND_RIGHT_RIM_SHAPE, FRAME_NORTH_BOTTOM_AND_LEFT_RIM_SHAPE,
                        FRAME_NORTH_RIGHT_AND_LEFT_RIM_SHAPE, FRAME_NORTH_TOP_AND_BOTTOM_RIM_SHAPE,
                        FRAME_NORTH_TOP_LEFT_AND_RIGHT_RIM_SHAPE, FRAME_NORTH_BOTTOM_LEFT_AND_RIGHT_RIM_SHAPE,
                        FRAME_NORTH_TOP_BOTTOM_AND_LEFT_RIM_SHAPE, FRAME_NORTH_TOP_BOTTOM_AND_RIGHT_RIM_SHAPE,
                        FRAME_NORTH_BACK_SHAPE, FRAME_NORTH_ALL_SHAPE);
            case SOUTH:
                return defineShapes(state, state.get(WEST), state.get(EAST), Direction.NORTH, FRAME_SOUTH_TOP_RIM_SHAPE,
                        FRAME_SOUTH_BOTTOM_RIM_SHAPE, FRAME_SOUTH_RIGHT_RIM_SHAPE, FRAME_SOUTH_LEFT_RIM_SHAPE,
                        FRAME_SOUTH_TOP_AND_RIGHT_RIM_SHAPE, FRAME_SOUTH_TOP_AND_LEFT_RIM_SHAPE,
                        FRAME_SOUTH_BOTTOM_AND_RIGHT_RIM_SHAPE, FRAME_SOUTH_BOTTOM_AND_LEFT_RIM_SHAPE,
                        FRAME_SOUTH_RIGHT_AND_LEFT_RIM_SHAPE, FRAME_SOUTH_TOP_AND_BOTTOM_RIM_SHAPE,
                        FRAME_SOUTH_TOP_LEFT_AND_RIGHT_RIM_SHAPE, FRAME_SOUTH_BOTTOM_LEFT_AND_RIGHT_RIM_SHAPE,
                        FRAME_SOUTH_TOP_BOTTOM_AND_LEFT_RIM_SHAPE, FRAME_SOUTH_TOP_BOTTOM_AND_RIGHT_RIM_SHAPE,
                        FRAME_SOUTH_BACK_SHAPE, FRAME_SOUTH_ALL_SHAPE);
            case WEST:
                return defineShapes(state, state.get(SOUTH), state.get(NORTH), Direction.WEST, FRAME_WEST_TOP_RIM_SHAPE,
                        FRAME_WEST_BOTTOM_RIM_SHAPE, FRAME_WEST_RIGHT_RIM_SHAPE, FRAME_WEST_LEFT_RIM_SHAPE,
                        FRAME_WEST_TOP_AND_RIGHT_RIM_SHAPE, FRAME_WEST_TOP_AND_LEFT_RIM_SHAPE,
                        FRAME_WEST_BOTTOM_AND_RIGHT_RIM_SHAPE, FRAME_WEST_BOTTOM_AND_LEFT_RIM_SHAPE,
                        FRAME_WEST_RIGHT_AND_LEFT_RIM_SHAPE, FRAME_WEST_TOP_AND_BOTTOM_RIM_SHAPE,
                        FRAME_WEST_TOP_LEFT_AND_RIGHT_RIM_SHAPE, FRAME_WEST_BOTTOM_LEFT_AND_RIGHT_RIM_SHAPE,
                        FRAME_WEST_TOP_BOTTOM_AND_LEFT_RIM_SHAPE, FRAME_WEST_TOP_BOTTOM_AND_RIGHT_RIM_SHAPE,
                        FRAME_WEST_BACK_SHAPE, FRAME_WEST_ALL_SHAPE);
            default:
                return defineShapes(state, state.get(SOUTH), state.get(NORTH), Direction.WEST, FRAME_EAST_TOP_RIM_SHAPE,
                        FRAME_EAST_BOTTOM_RIM_SHAPE, FRAME_EAST_RIGHT_RIM_SHAPE, FRAME_EAST_LEFT_RIM_SHAPE,
                        FRAME_EAST_TOP_AND_RIGHT_RIM_SHAPE, FRAME_EAST_TOP_AND_LEFT_RIM_SHAPE,
                        FRAME_EAST_BOTTOM_AND_RIGHT_RIM_SHAPE, FRAME_EAST_BOTTOM_AND_LEFT_RIM_SHAPE,
                        FRAME_EAST_RIGHT_AND_LEFT_RIM_SHAPE, FRAME_EAST_TOP_AND_BOTTOM_RIM_SHAPE,
                        FRAME_EAST_TOP_LEFT_AND_RIGHT_RIM_SHAPE, FRAME_EAST_BOTTOM_LEFT_AND_RIGHT_RIM_SHAPE,
                        FRAME_EAST_TOP_BOTTOM_AND_LEFT_RIM_SHAPE, FRAME_EAST_TOP_BOTTOM_AND_RIGHT_RIM_SHAPE,
                        FRAME_EAST_BACK_SHAPE, FRAME_EAST_ALL_SHAPE);
        }
    }
    ...
    public static VoxelShape defineShapes(BlockState state, Boolean firstSide, Boolean secondSide,
            Direction secondDirection, VoxelShape frameTopRim, VoxelShape frameBottomRim, VoxelShape frameRightRim,
            VoxelShape frameLeftRim, VoxelShape frameTopAndRightRim, VoxelShape frameTopAndLeftRim,
            VoxelShape frameBottomAndRightRim, VoxelShape frameBottomAndLeftRim, VoxelShape frameRightAndLeftRim,
            VoxelShape frameTopAndBottomRim, VoxelShape frameTopLeftAndRightRim, VoxelShape frameBottomLeftAndRightRim,
            VoxelShape frameTopBottomAndLeftRim, VoxelShape frameTopBottomAndRightRim, VoxelShape frameNone,
            VoxelShape frameAll)
    {
    ...
    static class VeTwoBlockPainting
    {
        ...
        /**
         * A helper method that returns true if both blocks can support the given
         * painting.
         */
        private static boolean framesFitPainting(BlockState clickedState, BlockState state2,
                VeFrameTileEntity clickedFrame, VeFrameTileEntity frame2)
        {
            return state2.getBlock() == clickedState.getBlock() && matchesFacing(clickedState, state2)
                    && isEmpty(clickedFrame) && isEmpty(frame2);
        }

        /**
         * A helper method that places the painting pieces in the frames if there are
         * available frames in the two positions and returns true otherwise it will
         * return false.
         */
        private static boolean addPaintingParts(World world, BlockPos clickedPos, BlockPos pos2,
                Map<Item, Item> clickedMap, Map<Item, Item> map2, ItemStack item)
        {
            ...
            if (clickedTileEntity instanceof VeFrameTileEntity && tileEntity2 instanceof VeFrameTileEntity)
            {
         ...
         * matchesFacing(clickedState, state2) && !isEmpty(clickedFrame) &&
         * !isEmpty(frame2) &&
    ...
    static class VeFourBlockPainting
    {
        ...
        /**
         * A helper method that checks if there are 4 available frames that can be
         * filled with the given painting.
         */
        /*
         * private static boolean framesFitPainting(BlockState clickedState, BlockState
         * state2, BlockState state3, BlockState state4, VeFrameTileEntity clickedFrame,
         ...
         * state3) && matchesFacing(clickedState, state4) && isEmpty(frame3) &&
         * isEmpty(frame4); } }
         */

        private static boolean addPaintingParts(World world, BlockPos clickedPos, BlockPos pos2, BlockPos pos3,
                BlockPos pos4, Map<Item, Item> clickedMap, Map<Item, Item> map2, Map<Item, Item> map3,
                Map<Item, Item> map4, ItemStack item)
        {
            BlockState clickedState = world.getBlockState(clickedPos);
            BlockState state2 = world.getBlockState(pos2);
            ...
            if (clickedState.getBlock() == state3.getBlock() && clickedState.getBlock() == state4.getBlock()
                    && matchesFacing(clickedState, state3) && matchesFacing(clickedState, state4) && isEmpty(frame3)
                    && isEmpty(frame4))
            {
        ...
        /**
         * A helper method that returns true if all 4 blocks make up the painting
         * harvested.
         */
        public static boolean isPaintingPart(BlockState clickedState, BlockState state2, BlockState state3,
                BlockState state4, VeFrameTileEntity clickedFrame, VeFrameTileEntity frame2, VeFrameTileEntity frame3,
                VeFrameTileEntity frame4, Map<Item, Item> clickedMap, Map<Item, Item> map2, Map<Item, Item> map3,
                Map<Item, Item> map4)
        {
            // return VeTwoBlockPainting.isPaintingPart(clickedState, state2, clickedFrame,
            // frame2, clickedMap, map2) &&
            return state3.getBlock() == clickedState.getBlock() && state4.getBlock() == clickedState.getBlock()
                    && !isEmpty(frame3) && !isEmpty(frame4)
                    && map3.containsValue(frame3.getInventory().get(0).getItem())
                    && map4.containsValue(frame4.getInventory().get(0).getItem());
        }

        private static void harvestPainting(BlockState clickedState, BlockState state2, BlockState state3,
                BlockState state4, VeFrameTileEntity clickedFrame, VeFrameTileEntity frame2, VeFrameTileEntity frame3,
                VeFrameTileEntity frame4, Map<Item, Item> clickedMap, Map<Item, Item> map2, Map<Item, Item> map3,
                Map<Item, Item> map4)
        {
            if (VeFourBlockPainting.isPaintingPart(clickedState, state2, state3, state4, clickedFrame, frame2, frame3,
                    frame4, clickedMap, map2, map3, map4))
            {
    ...
    static class VeEightBlockPainting
    {
         ...
         */
        /*
         * private static boolean frameFitsPainting(BlockState clickedState, BlockState
         * state2, BlockState state3, BlockState state4, BlockState state5, BlockState
         * state6, BlockState state7, BlockState state8, VeFrameTileEntity clickedFrame,
         * VeFrameTileEntity frame2, VeFrameTileEntity frame3, VeFrameTileEntity frame4,
         * VeFrameTileEntity frame5, VeFrameTileEntity frame6, VeFrameTileEntity frame7,
         * VeFrameTileEntity frame8) { return
         * VeFourBlockPainting.frameFitsPainting(clickedState, state2, state3, state4,
         * clickedFrame, frame2, frame3, frame4) && clickedState.getBlock() ==
         * state5.getBlock() && clickedState.getBlock() == state6.getBlock() &&
         * clickedState.getBlock() == state7.getBlock() && clickedState.getBlock() ==
         * state8.getBlock() && matchesFacing(clickedState, state5) &&
         * matchesFacing(clickedState, state6) && matchesFacing(clickedState, state7) &&
         * matchesFacing(clickedState, state8) && isEmpty(frame5) && isEmpty(frame6) &&
         * isEmpty(frame7) && isEmpty(frame8); }
         */
    }
}
