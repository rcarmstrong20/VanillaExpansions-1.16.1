...
public class VePlushBlock extends HorizontalBlock implements IWaterLoggable
{
	...
	protected static final VoxelShape BLAZE_NORTH_HEAD_SHAPE = Block.makeCuboidShape(5.5D, 8.0D, 5.5D, 10.5D, 13.0D, 10.5D);
	...
	protected static final VoxelShape BLAZE_NORTH_LEGS_SHAPE = VoxelShapes.or(BLAZE_NORTH_WEST_BOTTOM_LEG_SHAPE,
																			   BLAZE_NORTH_EAST_BOTTOM_LEG_SHAPE,
																			   BLAZE_SOUTH_WEST_BOTTOM_LEG_SHAPE,
																			   BLAZE_SOUTH_EAST_BOTTOM_LEG_SHAPE,
																			   BLAZE_SOUTH_TOP_LEG_SHAPE,
																			   BLAZE_WEST_TOP_LEG_SHAPE,
																			   BLAZE_EAST_TOP_LEG_SHAPE);
	...
	protected static final VoxelShape BLAZE_NORTH_SHAPE = VoxelShapes.or(BLAZE_NORTH_HEAD_SHAPE,
																		 BLAZE_NORTH_LEGS_SHAPE,
	...
	protected static final VoxelShape CREEPER_NORTH_HEAD_SHAPE = Block.makeCuboidShape(4.5D, 9.0D, 4.5D, 11.5D, 16.0D, 11.5D);
	protected static final VoxelShape CREEPER_NORTH_TORSO_SHAPE = Block.makeCuboidShape(5.5D, 3.0D, 5.5D, 10.5D, 9.0D, 10.5D);
	protected static final VoxelShape CREEPER_NORTH_FRONT_FOOT_SHAPE = Block.makeCuboidShape(5.5D, 0.0D, 2.5D, 10.5D, 3.0D, 5.5D);
	protected static final VoxelShape CREEPER_NORTH_BACK_FOOT_SHAPE = Block.makeCuboidShape(5.5D, 0.0D, 10.5D, 10.5D, 3.0D, 13.5D);
	...
	protected static final VoxelShape CREEPER_NORTH_MOUTH_SHAPE = VoxelShapes.or(CREEPER_NORTH_MIDDLE_MOUTH_SHAPE,
																				CREEPER_NORTH_RIGHT_MOUTH_SHAPE,
																				CREEPER_NORTH_LEFT_MOUTH_SHAPE);
	
	protected static final VoxelShape CREEPER_NORTH_SHAPE = VoxelShapes.or(CREEPER_NORTH_HEAD_SHAPE,
																		   CREEPER_NORTH_TORSO_SHAPE,
																		   CREEPER_NORTH_FEET_SHAPE,
																		   CREEPER_NORTH_EYES_SHAPE,
																		   CREEPER_NORTH_MOUTH_SHAPE);
	...
	protected static final VoxelShape ZOMBIE_DEMON_NORTH_HORNS_SHAPE = VoxelShapes.or(ZOMBIE_DEMON_NORTH_HORN1_BOTTOM_SHAPE,
																					  ZOMBIE_DEMON_NORTH_HORN1_TOP_SHAPE,
																					  ZOMBIE_DEMON_NORTH_HORN2_BOTTOM_SHAPE,
																					  ZOMBIE_DEMON_NORTH_HORN2_TOP_SHAPE);
	...
	protected static final VoxelShape ZOMBIE_PIGMAN_NORTH_HEAD_PIECES_SHAPE = VoxelShapes.or(ZOMBIE_PIGMAN_NORTH_LEFT_HEAD_PIECE1_FRONT_SHAPE,
																							 ZOMBIE_PIGMAN_NORTH_LEFT_HEAD_PIECE2_FRONT_SHAPE,
																							 ZOMBIE_PIGMAN_NORTH_LEFT_HEAD_PIECE3_FRONT_SHAPE,
																							 ZOMBIE_PIGMAN_NORTH_LEFT_HEAD_PIECE4_FRONT_SHAPE,
																							 ZOMBIE_PIGMAN_NORTH_LEFT_HEAD_PIECE1_SIDE_SHAPE,
																							 ZOMBIE_PIGMAN_NORTH_LEFT_HEAD_PIECE2_SIDE_SHAPE,
																							 ZOMBIE_PIGMAN_NORTH_LEFT_HEAD_PIECE3_SIDE_SHAPE,
																							 ZOMBIE_PIGMAN_NORTH_LEFT_HEAD_PIECE_TOP_SHAPE);
	
	protected static final VoxelShape ZOMBIE_PIGMAN_NORTH_RIBCAGE_SHAPE = VoxelShapes.or(ZOMBIE_PIGMAN_NORTH_RIBCAGE_PIECE1_SHAPE,
																						 ZOMBIE_PIGMAN_NORTH_RIBCAGE_PIECE2_SHAPE,
																						 ZOMBIE_PIGMAN_NORTH_RIBCAGE_PIECE3_SHAPE,
																						 ZOMBIE_PIGMAN_NORTH_RIBCAGE_PIECE4_SHAPE);
	
	protected static final VoxelShape ZOMBIE_PIGMAN_NORTH_STRAP_SHAPE = VoxelShapes.or(ZOMBIE_PIGMAN_NORTH_TOP_STRAP_SHAPE,
																					   ZOMBIE_PIGMAN_NORTH_BOTTOM_STRAP_SHAPE);
	
	protected static final VoxelShape ZOMBIE_PIGMAN_NORTH_SHAPE = VoxelShapes.or(ZOMBIE_PIGMAN_NORTH_RIGHT_EYE_SHAPE,
																				 ZOMBIE_PIGMAN_NORTH_HEAD_PIECES_SHAPE,
																				 ZOMBIE_PIGMAN_NORTH_RIBCAGE_SHAPE,
																				 ZOMBIE_PIGMAN_NORTH_STRAP_SHAPE,
	...
	protected static final VoxelShape ENDERMITE_NORTH_SHAPE = VoxelShapes.or(ENDERMITE_NORTH_FRONT_SHAPE,
																			 ENDERMITE_NORTH_MIDDLE_SHAPE,
																			 ENDERMITE_NORTH_BACK1_SHAPE,
																			 ENDERMITE_NORTH_BACK2_SHAPE);
	...
	protected static final VoxelShape SHEEP_NORTH_BACK_RIGHT_LEG_TUFF_SHAPE = Block.makeCuboidShape(8.5D, 2.0D, 3.5D, 11.0D, 4.0D, 6.0D);
	protected static final VoxelShape SHEEP_NORTH_BACK_RIGHT_LEG_SHAPE = Block.makeCuboidShape(9.0D, 0.0D, 4.0D, 10.5D, 2.0D, 5.5D);
	protected static final VoxelShape SHEEP_NORTH_BACK_LEFT_LEG_TUFF_SHAPE = Block.makeCuboidShape(5.0D, 2.0D, 3.5D, 7.5D, 4.0D, 6.0D);
	protected static final VoxelShape SHEEP_NORTH_BACK_LEFT_LEG_SHAPE = Block.makeCuboidShape(5.5D, 0.0D, 4.0D, 7.0D, 2.0D, 5.5D);
	protected static final VoxelShape SHEEP_NORTH_FRONT_RIGHT_LEG_TUFF_SHAPE = Block.makeCuboidShape(8.5D, 2.0D, 10.0D, 11.0D, 4.0D, 12.5D);
	protected static final VoxelShape SHEEP_NORTH_FRONT_RIGHT_LEG_SHAPE = Block.makeCuboidShape(9.0D, 0.0D, 10.5D, 10.5D, 2.0D, 12.0D);
	protected static final VoxelShape SHEEP_NORTH_FRONT_LEFT_LEG_TUFF_SHAPE = Block.makeCuboidShape(5.0D, 2.0D, 10.0D, 7.5D, 4.0D, 12.5D);
	protected static final VoxelShape SHEEP_NORTH_FRONT_LEFT_LEG_SHAPE = Block.makeCuboidShape(5.5D, 0.0D, 10.5D, 7.0D, 2.0D, 12.0D);
	...
	protected static final VoxelShape SHEEP_NORTH_LEG_TUFFS_SHAPE = VoxelShapes.or(SHEEP_NORTH_BACK_RIGHT_LEG_TUFF_SHAPE,
																				   SHEEP_NORTH_BACK_LEFT_LEG_TUFF_SHAPE,
																				   SHEEP_NORTH_FRONT_RIGHT_LEG_TUFF_SHAPE,
																				   SHEEP_NORTH_FRONT_LEFT_LEG_TUFF_SHAPE);
	
	protected static final VoxelShape SHEEP_NORTH_LEGS_SHAPE = VoxelShapes.or(SHEEP_NORTH_BACK_RIGHT_LEG_SHAPE,
			   																  SHEEP_NORTH_BACK_LEFT_LEG_SHAPE,
			   																  SHEEP_NORTH_FRONT_RIGHT_LEG_SHAPE,
			   																  SHEEP_NORTH_FRONT_LEFT_LEG_SHAPE);
	...
	protected static final VoxelShape SHEEP_NORTH_SHAPE = VoxelShapes.or(SHEEP_NORTH_HEAD_SHAPE,
																		 SHEEP_NORTH_TORSO_SHAPE,
																		 SHEEP_NORTH_FOREHEAD_SHAPE,
																		 SHEEP_NORTH_EARS_SHAPE,
																		 SHEEP_NORTH_MOUTH_SHAPE,
																		 SHEEP_NORTH_LEG_TUFFS_SHAPE,
																		 SHEEP_NORTH_LEGS_SHAPE,
																		 SHEEP_NORTH_EYES_SHAPE);
	...
	protected static final VoxelShape CHICKEN_NORTH_FEET_SHAPE = Block.makeCuboidShape(5.0D, 0.0D, 7.5D, 11.0D, 0.5D, 8.5D);
	...
	protected static final VoxelShape CHICKEN_NORTH_LEGS_SHAPE = VoxelShapes.or(CHICKEN_NORTH_LEFT_LEG_BACK_SHAPE,
																				CHICKEN_NORTH_RIGHT_LEG_BACK_SHAPE,
																				CHICKEN_NORTH_LEFT_LEG_FRONT_SHAPE,
	...
	protected static final VoxelShape CHICKEN_NORTH_SHAPE = VoxelShapes.or(CHICKEN_NORTH_FEET_SHAPE,
																		   CHICKEN_NORTH_TORSO_SHAPE,
																		   CHICKEN_NORTH_WINGS_SHAPE,
																		   CHICKEN_NORTH_HEAD_SHAPE,
																		   CHICKEN_NORTH_WATTLE_SHAPE,
																		   CHICKEN_NORTH_BEAK_SHAPE,
																		   CHICKEN_NORTH_LEGS_SHAPE,
																		   CHICKEN_NORTH_EYES_SHAPE);
	...
	protected static final VoxelShape SQUID_LEGS_SHAPE = VoxelShapes.or(SQUID_LEG1_SHAPE,
																		SQUID_LEG2_SHAPE,
																		SQUID_LEG3_SHAPE,
																		SQUID_LEG4_SHAPE,
																		SQUID_LEG5_SHAPE,
	...
	protected static final VoxelShape SQUID_TEETH_SHAPE = VoxelShapes.or(SQUID_TOOTH1_SHAPE,
																		 SQUID_TOOTH2_SHAPE,
																		 SQUID_TOOTH3_SHAPE,
																		 SQUID_TOOTH4_SHAPE,
																		 SQUID_TOOTH5_SHAPE,
	...
	protected static final VoxelShape SQUID_NORTH_SHAPE = VoxelShapes.or(SQUID_BODY_SHAPE,
																		 SQUID_MOUTH_SHAPE,
																		 SQUID_LEGS_SHAPE,
																		 SQUID_TEETH_SHAPE,
																		 SQUID_NORTH_EYES_SHAPE);
	...
	protected static final VoxelShape PIG_NORTH_LEGS_SHAPE = VoxelShapes.or(PIG_NORTH_FRONT_RIGHT_LEG_SHAPE,
																			PIG_NORTH_FRONT_LEFT_LEG_SHAPE,
																			PIG_NORTH_BACK_RIGHT_LEG_SHAPE,
																			PIG_NORTH_BACK_LEFT_LEG_SHAPE);
	
	protected static final VoxelShape PIG_NORTH_TAIL_SHAPE = VoxelShapes.or(PIG_NORTH_TAIL1_SHAPE,
																			PIG_NORTH_TAIL2_SHAPE,
																			PIG_NORTH_TAIL3_SHAPE,
																			PIG_NORTH_TAIL4_SHAPE,
																			PIG_NORTH_TAIL5_SHAPE);
	
	protected static final VoxelShape PIG_NORTH_EYES_SHAPE = VoxelShapes.or(PIG_NORTH_RIGHT_EYE_SHAPE,
																		    PIG_NORTH_LEFT_EYE_SHAPE);
	
	protected static final VoxelShape PIG_NORTH_SHAPE = VoxelShapes.or(PIG_NORTH_BODY_SHAPE,
																	   PIG_NORTH_HEAD_SHAPE,
																	   PIG_NORTH_LEGS_SHAPE,
																	   PIG_NORTH_TAIL_SHAPE,
																	   PIG_NORTH_EYES_SHAPE,
																	   PIG_NORTH_SNOUT_SHAPE);
	...
	protected static final VoxelShape COW_NORTH_LEFT_FRONT_LEG_SHAPE = Block.makeCuboidShape(5.0D, 0.0D, 5.0D, 7.0D, 4.0D, 7.0D);
	...
	protected static final VoxelShape COW_NORTH_LEGS_SHAPE = VoxelShapes.or(COW_NORTH_LEFT_FRONT_LEG_SHAPE,
																			COW_NORTH_RIGHT_FRONT_LEG_SHAPE,
																			COW_NORTH_RIGHT_BACK_LEG_SHAPE,
																			COW_NORTH_LEFT_BACK_LEG_SHAPE);
	...
	protected static final VoxelShape COW_NORTH_SHAPE = VoxelShapes.or(COW_NORTH_TORSO_SHAPE,
																	   COW_NORTH_HEAD_SHAPE,
																	   COW_NORTH_UTTERS_SHAPE,
																	   COW_NORTH_MOUTH_SHAPE,
																	   COW_NORTH_LEGS_SHAPE,
																	   COW_NORTH_HORNS_SHAPE,
	...
	protected static final VoxelShape BABY_COW_NORTH_FACE_SHAPE = VoxelShapes.or(BABY_COW_NORTH_MOUTH_SHAPE,
																				 BABY_COW_NORTH_RIGHT_EYE_SHAPE,
																				 BABY_COW_NORTH_LEFT_EYE_SHAPE);
	...
	protected static final VoxelShape BABY_COW_NORTH_LEGS_SHAPE = VoxelShapes.or(BABY_COW_NORTH_RIGHT_FRONT_LEG_SHAPE,
																				 BABY_COW_NORTH_LEFT_FRONT_LEG_SHAPE,
																				 BABY_COW_NORTH_RIGHT_BACK_LEG_SHAPE,
	...
	protected static final VoxelShape BABY_COW_NORTH_SHAPE = VoxelShapes.or(BABY_COW_NORTH_FACE_SHAPE,
																			BABY_COW_NORTH_HORNS_SHAPE,
																			BABY_COW_NORTH_LEGS_SHAPE,
																			BABY_COW_NORTH_BODY_SHAPE,
																			BABY_COW_NORTH_HEAD_SHAPE,
	...
	protected static final VoxelShape MOOSHROOM_NORTH_HEAD_MUSHROOM_SHAPE = VoxelShapes.or(MOOSHROOM_NORTH_HEAD_MUSHROOM_STEM_SHAPE,
																						   MOOSHROOM_NORTH_HEAD_MUSHROOM_BOTTOM_SHAPE,
																						   MOOSHROOM_NORTH_HEAD_MUSHROOM_TOP_SHAPE);
	
	protected static final VoxelShape MOOSHROOM_NORTH_BODY1_MUSHROOM_SHAPE = VoxelShapes.or(MOOSHROOM_NORTH_BODY1_MUSHROOM_STEM_SHAPE,
			   																			    MOOSHROOM_NORTH_BODY1_MUSHROOM_BOTTOM_SHAPE,
			   																			    MOOSHROOM_NORTH_BODY1_MUSHROOM_TOP_SHAPE);
	
	protected static final VoxelShape MOOSHROOM_NORTH_BODY2_MUSHROOM_SHAPE = VoxelShapes.or(MOOSHROOM_NORTH_BODY2_MUSHROOM_STEM_SHAPE,
			   																				MOOSHROOM_NORTH_BODY2_MUSHROOM_BOTTOM_SHAPE,
	...
	protected static final VoxelShape MOOSHROOM_NORTH_SHAPE = VoxelShapes.or(MOOSHROOM_NORTH_HEAD_MUSHROOM_SHAPE,
																			 MOOSHROOM_NORTH_BODY1_MUSHROOM_SHAPE,
																			 MOOSHROOM_NORTH_BODY2_MUSHROOM_SHAPE,
																			 COW_NORTH_SHAPE);
	...
	protected static final VoxelShape BABY_MOOSHROOM_NORTH_MUSHROOM_SHAPE = VoxelShapes.or(BABY_MOOSHROOM_NORTH_MUSHROOM_STEM_SHAPE,
																						   BABY_MOOSHROOM_NORTH_MUSHROOM_BOTTOM_SHAPE,
	...
	protected static final VoxelShape OCELOT_NORTH_FRONT_RIGHT_LEG_SHAPE = Block.makeCuboidShape(9.0D, 0.0D, 7.5D, 10.0D, 2.0D, 8.5D);
	protected static final VoxelShape OCELOT_NORTH_FRONT_LEFT_LEG_SHAPE = Block.makeCuboidShape(6.0D, 0.0D, 7.5D, 7.0D, 2.0D, 8.5D);
	...
	protected static final VoxelShape OCELOT_NORTH_LEGS_SHAPE = VoxelShapes.or(OCELOT_NORTH_FRONT_RIGHT_LEG_SHAPE,
																			   OCELOT_NORTH_FRONT_LEFT_LEG_SHAPE,
																			   OCELOT_NORTH_BACK_RIGHT_LEG_SHAPE,
																			   OCELOT_NORTH_BACK_LEFT_LEG_SHAPE);
	...
	protected static final VoxelShape OCELOT_NORTH_BODY_SHAPE = VoxelShapes.or(OCELOT_NORTH_TORSO_SHAPE,
																			   OCELOT_NORTH_HEAD_SHAPE,
																			   OCELOT_NORTH_LEGS_SHAPE,
																			   OCELOT_NORTH_TAIL_SHAPE,
																			   OCELOT_NORTH_EARS_SHAPE,
	...
	protected static final VoxelShape WOLF_NORTH_LEGS_SHAPE = VoxelShapes.or(WOLF_NORTH_FRONT_RIGHT_LEG_SHAPE,
																			 WOLF_NORTH_FRONT_LEFT_LEG_SHAPE,
																			 WOLF_NORTH_BACK_RIGHT_LEG_SHAPE,
																			 WOLF_NORTH_BACK_LEFT_LEG_SHAPE);
	...
	protected static final VoxelShape WOLF_NORTH_SHAPE = VoxelShapes.or(WOLF_NORTH_HEAD_SHAPE,
																		WOLF_NORTH_TORSO_SHAPE,
																		WOLF_NORTH_SNOUT_SHAPE,
																		WOLF_NORTH_LEGS_SHAPE,
																		WOLF_NORTH_EYES_SHAPE,
																		WOLF_NORTH_EARS_SHAPE,
	...
	protected static final VoxelShape ENDERMAN_NORTH_ARMS_SHAPE = VoxelShapes.or(ENDERMAN_NORTH_RIGHT_ARM1_SHAPE,
																				 ENDERMAN_NORTH_RIGHT_ARM2_SHAPE,
																				 ENDERMAN_NORTH_MIDDLE_ARM_SHAPE,
																				 ENDERMAN_NORTH_LEFT_ARM1_SHAPE,
	...
	protected static final VoxelShape ENDERMAN_NORTH_SHAPE = VoxelShapes.or(ENDERMAN_NORTH_BODY_SHAPE,
																			ENDERMAN_NORTH_EYES_SHAPE,
																			ENDERMAN_NORTH_LEGS_SHAPE,
																			ENDERMAN_NORTH_ARMS_SHAPE,
	...
	protected static final VoxelShape GHAST_NORTH_RIGHT_TEAR_SHAPES = VoxelShapes.or(GHAST_NORTH_RIGHT_EYE_TEAR_TOP_SHAPE,
																					 GHAST_NORTH_RIGHT_EYE_TEAR_MIDDLE_SHAPE,
	...
	protected static final VoxelShape GHAST_NORTH_LEFT_TEAR_SHAPES = VoxelShapes.or(GHAST_NORTH_LEFT_EYE_TEAR_TOP_SHAPE,
																					GHAST_NORTH_LEFT_EYE_TEAR_MIDDLE_SHAPE,
																					GHAST_NORTH_LEFT_EYE_TEAR_BOTTOM_SHAPE);
	
	protected static final VoxelShape GHAST_NORTH_RIGHT_TENTACLES_SHAPES = VoxelShapes.or(GHAST_NORTH_FRONT_RIGHT_TENTACE_1_PART_1_SHAPE,
																						  GHAST_NORTH_FRONT_RIGHT_TENTACE_1_PART_2_SHAPE,
	...
	protected static final VoxelShape GHAST_NORTH_MIDDLE_TENTACLES_SHAPES = VoxelShapes.or(GHAST_NORTH_FRONT_MIDDLE_TENTACE_1_PART_1_SHAPE,
																						   GHAST_NORTH_FRONT_MIDDLE_TENTACE_1_PART_2_SHAPE,
																						   GHAST_NORTH_MIDDLE_MIDDLE_TENTACE_2_PART_1_SHAPE,
																						   GHAST_NORTH_MIDDLE_MIDDLE_TENTACE_2_PART_2_SHAPE,
	...
	protected static final VoxelShape GHAST_NORTH_LEFT_TENTACLES_SHAPES = VoxelShapes.or(GHAST_NORTH_FRONT_LEFT_TENTACE_1_PART_1_SHAPE,
																						 GHAST_NORTH_FRONT_LEFT_TENTACE_1_PART_2_SHAPE,
																						 GHAST_NORTH_MIDDLE_LEFT_TENTACE_2_PART_1_SHAPE,
																						 GHAST_NORTH_MIDDLE_LEFT_TENTACE_2_PART_2_SHAPE,
	...
	protected static final VoxelShape GHAST_NORTH_SHAPE = VoxelShapes.or(GHAST_NORTH_EYE_SHAPES,
																		 GHAST_NORTH_RIGHT_TEAR_SHAPES,
																		 GHAST_NORTH_LEFT_TEAR_SHAPES,
																		 GHAST_NORTH_RIGHT_TENTACLES_SHAPES,
																		 GHAST_NORTH_MIDDLE_TENTACLES_SHAPES,
																		 GHAST_NORTH_LEFT_TENTACLES_SHAPES,
																		 GHAST_NORTH_BODY_SHAPE,
	...
	protected static final VoxelShape SPIDER_NORTH_EYES_SHAPE = VoxelShapes.or(SPIDER_NORTH_MIDDLE_EYE_SHAPE,
																			   SPIDER_NORTH_RIGHT_EYE_SHAPE,
																			   SPIDER_NORTH_LEFT_EYE_SHAPE);
	
	protected static final VoxelShape SPIDER_NORTH_EYEBROWS_SHAPE = VoxelShapes.or(SPIDER_NORTH_RIGHT_BOTTOM_EYEBROW_SHAPE,
																				   SPIDER_NORTH_RIGHT_TOP_EYEBROW_SHAPE,
																				   SPIDER_NORTH_LEFT_BOTTOM_EYEBROW_SHAPE,
																				   SPIDER_NORTH_LEFT_TOP_EYEBROW_SHAPE);
	...
	protected static final VoxelShape SPIDER_NORTH_RIGHT_LEGS_SHAPE = VoxelShapes.or(SPIDER_NORTH_RIGHT_LEG1_TOP_SHAPE,
																					 SPIDER_NORTH_RIGHT_LEG1_BOTTOM_SHAPE,
																					 SPIDER_NORTH_RIGHT_LEG2_TOP_SHAPE,
																					 SPIDER_NORTH_RIGHT_LEG2_BOTTOM_SHAPE,
																					 SPIDER_NORTH_RIGHT_LEG3_TOP_SHAPE,
																					 SPIDER_NORTH_RIGHT_LEG3_BOTTOM_SHAPE,
																					 SPIDER_NORTH_RIGHT_LEG4_TOP_SHAPE,
	...
	protected static final VoxelShape SPIDER_NORTH_LEFT_LEGS_SHAPE = VoxelShapes.or(SPIDER_NORTH_LEFT_LEG1_TOP_SHAPE,
																					SPIDER_NORTH_LEFT_LEG1_BOTTOM_SHAPE,
																					SPIDER_NORTH_LEFT_LEG2_TOP_SHAPE,
																					SPIDER_NORTH_LEFT_LEG2_BOTTOM_SHAPE,
																					SPIDER_NORTH_LEFT_LEG3_TOP_SHAPE,
																					SPIDER_NORTH_LEFT_LEG3_BOTTOM_SHAPE,
																					SPIDER_NORTH_LEFT_LEG4_TOP_SHAPE,
	...
	protected static final VoxelShape SPIDER_NORTH_SHAPE = VoxelShapes.or(SPIDER_NORTH_BODY_SHAPE,
																		  SPIDER_NORTH_HEAD_SHAPE,
																		  SPIDER_NORTH_EYES_SHAPE,
																		  SPIDER_NORTH_EYEBROWS_SHAPE,
																		  SPIDER_NORTH_FANGS_SHAPE,
																		  SPIDER_NORTH_RIGHT_LEGS_SHAPE,
																		  SPIDER_NORTH_LEFT_LEGS_SHAPE);
	...
	protected static final VoxelShape CAVE_SPIDER_NORTH_BODY_SHAPE = Block.makeCuboidShape(5.0D, 0.0D, 5.0D, 10.0D, 4.0D, 13.0D);
	protected static final VoxelShape CAVE_SPIDER_NORTH_HEAD_SHAPE = Block.makeCuboidShape(6.0D, 0.0D, 2.5D, 9.0D, 3.0D, 5.0D);
	protected static final VoxelShape CAVE_SPIDER_NORTH_RIGHT_FANG_SHAPE = Block.makeCuboidShape(6.5D, 0.0D, 2.0D, 7.0D, 0.5D, 2.5D);
	protected static final VoxelShape CAVE_SPIDER_NORTH_LEFT_FANG_SHAPE = Block.makeCuboidShape(8.0D, 0.0D, 2.0D, 8.5D, 0.5D, 2.5D);
	protected static final VoxelShape CAVE_SPIDER_NORTH_MOUTH_SHAPE = Block.makeCuboidShape(7.0D, 0.5D, 2.0D, 8.0D, 1.0D, 2.5D);
	protected static final VoxelShape CAVE_SPIDER_NORTH_MIDDLE_EYEBROW_SHAPE = Block.makeCuboidShape(7.0D, 1.5D, 2.0D, 8.0D, 2.0D, 2.5D);
	protected static final VoxelShape CAVE_SPIDER_NORTH_RIGHT_EYEBROW_SHAPE = Block.makeCuboidShape(6.5D, 2.0D, 2.0D, 7.0D, 2.5D, 2.5D);
	protected static final VoxelShape CAVE_SPIDER_NORTH_LEFT_EYEBROW_SHAPE = Block.makeCuboidShape(8.0D, 2.0D, 2.0D, 8.5D, 2.5D, 2.5D);
	protected static final VoxelShape CAVE_SPIDER_NORTH_RIGHT_EYE_SHAPE = Block.makeCuboidShape(6.0D, 1.0D, 2.0D, 6.5D, 1.5D, 2.5D);
	protected static final VoxelShape CAVE_SPIDER_NORTH_LEFT_EYE_SHAPE = Block.makeCuboidShape(8.5D, 1.0D, 2.0D, 9.0D, 1.5D, 2.5D);
	protected static final VoxelShape CAVE_SPIDER_NORTH_RIGHT_LEG1_TOP_SHAPE = Block.makeCuboidShape(3.0D, 1.0D, 5.0D, 5.0D, 2.0D, 6.0D);
	protected static final VoxelShape CAVE_SPIDER_NORTH_RIGHT_LEG2_TOP_SHAPE = Block.makeCuboidShape(3.0D, 1.0D, 7.0D, 5.0D, 2.0D, 8.0D);
	protected static final VoxelShape CAVE_SPIDER_NORTH_RIGHT_LEG3_TOP_SHAPE = Block.makeCuboidShape(3.5D, 1.0D, 9.0D, 5.0D, 2.0D, 10.0D);
	protected static final VoxelShape CAVE_SPIDER_NORTH_RIGHT_LEG4_TOP_SHAPE = Block.makeCuboidShape(4.0D, 1.0D, 11.0D, 5.0D, 2.0D, 12.0D);
	protected static final VoxelShape CAVE_SPIDER_NORTH_RIGHT_LEG1_BOTTOM_SHAPE = Block.makeCuboidShape(2.0D, 0.0D, 6.0D, 3.0D, 1.0D, 7.0D);
	protected static final VoxelShape CAVE_SPIDER_NORTH_RIGHT_LEG2_BOTTOM_SHAPE = Block.makeCuboidShape(2.0D, 0.0D, 8.0D, 3.0D, 1.0D, 9.0D);
	protected static final VoxelShape CAVE_SPIDER_NORTH_RIGHT_LEG3_BOTTOM_SHAPE = Block.makeCuboidShape(2.5D, 0.0D, 10.0D, 3.5D, 1.0D, 11.0D);
	protected static final VoxelShape CAVE_SPIDER_NORTH_RIGHT_LEG4_BOTTOM_SHAPE = Block.makeCuboidShape(3.0D, 0.0D, 12.0D, 4.0D, 1.0D, 13.0D);
	protected static final VoxelShape CAVE_SPIDER_NORTH_LEFT_LEG1_TOP_SHAPE = Block.makeCuboidShape(10.0D, 1.0D, 5.0D, 12.0D, 2.0D, 6.0D);
	protected static final VoxelShape CAVE_SPIDER_NORTH_LEFT_LEG2_TOP_SHAPE = Block.makeCuboidShape(10.0D, 1.0D, 7.0D, 12.0D, 2.0D, 8.0D);
	protected static final VoxelShape CAVE_SPIDER_NORTH_LEFT_LEG3_TOP_SHAPE = Block.makeCuboidShape(10.0D, 1.0D, 9.0D, 11.5D, 2.0D, 10.0D);
	protected static final VoxelShape CAVE_SPIDER_NORTH_LEFT_LEG4_TOP_SHAPE = Block.makeCuboidShape(10.0D, 1.0D, 11.0D, 11.0D, 2.0D, 12.0D);
	protected static final VoxelShape CAVE_SPIDER_NORTH_LEFT_LEG1_BOTTOM_SHAPE = Block.makeCuboidShape(12.0D, 0.0D, 6.0D, 13.0D, 1.0D, 7.0D);
	protected static final VoxelShape CAVE_SPIDER_NORTH_LEFT_LEG2_BOTTOM_SHAPE = Block.makeCuboidShape(12.0D, 0.0D, 8.0D, 13.0D, 1.0D, 9.0D);
	protected static final VoxelShape CAVE_SPIDER_NORTH_LEFT_LEG3_BOTTOM_SHAPE = Block.makeCuboidShape(11.5D, 0.0D, 10.0D, 12.5D, 1.0D, 11.0D);
	protected static final VoxelShape CAVE_SPIDER_NORTH_LEFT_LEG4_BOTTOM_SHAPE = Block.makeCuboidShape(11.0D, 0.0D, 12.0D, 12.0D, 1.0D, 13.0D);
	
	protected static final VoxelShape CAVE_SPIDER_NORTH_MOUTH_AND_FANGS_SHAPE = VoxelShapes.or(CAVE_SPIDER_NORTH_RIGHT_FANG_SHAPE,
																							   CAVE_SPIDER_NORTH_LEFT_FANG_SHAPE,
																							   CAVE_SPIDER_NORTH_MOUTH_SHAPE);
	
	protected static final VoxelShape CAVE_SPIDER_NORTH_EYEBROW_SHAPE = VoxelShapes.or(CAVE_SPIDER_NORTH_MIDDLE_EYEBROW_SHAPE,
																					   CAVE_SPIDER_NORTH_RIGHT_EYEBROW_SHAPE,
	...
	protected static final VoxelShape CAVE_SPIDER_NORTH_RIGHT_LEGS_SHAPE = VoxelShapes.or(CAVE_SPIDER_NORTH_RIGHT_LEG1_TOP_SHAPE,
																						  CAVE_SPIDER_NORTH_RIGHT_LEG2_TOP_SHAPE,
																						  CAVE_SPIDER_NORTH_RIGHT_LEG3_TOP_SHAPE,
																						  CAVE_SPIDER_NORTH_RIGHT_LEG4_TOP_SHAPE,
																						  CAVE_SPIDER_NORTH_RIGHT_LEG1_BOTTOM_SHAPE,
																						  CAVE_SPIDER_NORTH_RIGHT_LEG2_BOTTOM_SHAPE,
																						  CAVE_SPIDER_NORTH_RIGHT_LEG3_BOTTOM_SHAPE,
																						  CAVE_SPIDER_NORTH_RIGHT_LEG4_BOTTOM_SHAPE);
	
	protected static final VoxelShape CAVE_SPIDER_NORTH_LEFT_LEGS_SHAPE = VoxelShapes.or(CAVE_SPIDER_NORTH_LEFT_LEG1_TOP_SHAPE,
																						 CAVE_SPIDER_NORTH_LEFT_LEG2_TOP_SHAPE,
																						 CAVE_SPIDER_NORTH_LEFT_LEG3_TOP_SHAPE,
																						 CAVE_SPIDER_NORTH_LEFT_LEG4_TOP_SHAPE,
																						 CAVE_SPIDER_NORTH_LEFT_LEG1_BOTTOM_SHAPE,
																						 CAVE_SPIDER_NORTH_LEFT_LEG2_BOTTOM_SHAPE,
																						 CAVE_SPIDER_NORTH_LEFT_LEG3_BOTTOM_SHAPE,
																						 CAVE_SPIDER_NORTH_LEFT_LEG4_BOTTOM_SHAPE);
	
	protected static final VoxelShape CAVE_SPIDER_NORTH_SHAPE = VoxelShapes.or(CAVE_SPIDER_NORTH_BODY_SHAPE,
																			   CAVE_SPIDER_NORTH_HEAD_SHAPE,
																			   CAVE_SPIDER_NORTH_MOUTH_AND_FANGS_SHAPE,
																			   CAVE_SPIDER_NORTH_EYEBROW_SHAPE,
																			   CAVE_SPIDER_NORTH_EYES_SHAPE,
																			   CAVE_SPIDER_NORTH_RIGHT_LEGS_SHAPE,
																			   CAVE_SPIDER_NORTH_LEFT_LEGS_SHAPE);
	
	protected static final VoxelShape CAVE_SPIDER_SOUTH_SHAPE = VeCollisionUtil.rotate180(Axis.Y, CAVE_SPIDER_NORTH_SHAPE);
	protected static final VoxelShape CAVE_SPIDER_WEST_SHAPE = VeCollisionUtil.rotate270(Axis.Y, CAVE_SPIDER_NORTH_SHAPE);
	protected static final VoxelShape CAVE_SPIDER_EAST_SHAPE = VeCollisionUtil.rotate90(Axis.Y, CAVE_SPIDER_NORTH_SHAPE);
	...
	protected static final VoxelShape HORSE_NORTH_HEAD_FRONT1_SHAPE = Block.makeCuboidShape(5.5D, 10.5D, 1.0D, 10.0D, 12.5D, 2.0D);
	protected static final VoxelShape HORSE_NORTH_HEAD_FRONT2_SHAPE = Block.makeCuboidShape(5.5D, 10.0D, 2.0D, 10.0D, 13.0D, 4.0D);
	protected static final VoxelShape HORSE_NORTH_HEAD_MIDDLE_SHAPE = Block.makeCuboidShape(5.5D, 9.5D, 3.0D, 10.0D, 14.5D, 5.0D);
	protected static final VoxelShape HORSE_NORTH_HEAD_BACK1_SHAPE = Block.makeCuboidShape(5.5D, 11.5D, 5.5D, 10.0D, 13.0D, 6.5D);
	protected static final VoxelShape HORSE_NORTH_HEAD_BACK2_SHAPE = Block.makeCuboidShape(5.5D, 10.0D, 5.0D, 10.0D, 13.5D, 5.5D);
	protected static final VoxelShape HORSE_NORTH_RIGHT_EYE_SHAPE = Block.makeCuboidShape(5.0D, 11.3D, 3.0D, 5.5D, 12.7D, 4.5D);
	protected static final VoxelShape HORSE_NORTH_LEFT_EYE_SHAPE = Block.makeCuboidShape(10.0D, 11.3D, 3.0D, 10.5D, 12.7D, 4.5D);
	protected static final VoxelShape HORSE_NORTH_RIGHT_EAR_SHAPE = Block.makeCuboidShape(6.0D, 13.0D, 1.5D, 7.5D, 15.0D, 3.5D);
	protected static final VoxelShape HORSE_NORTH_LEFT_EAR_SHAPE = Block.makeCuboidShape(8.0D, 13.0D, 1.5D, 9.5D, 15.0D, 3.5D);
	...
	protected static final VoxelShape HORSE_NORTH_LEG_PUFFS_SHAPE = VoxelShapes.or(HORSE_NORTH_FRONT_LEFT_LEG_PUFF_SHAPE,
																				   HORSE_NORTH_BACK_LEFT_LEG_PUFF_SHAPE,
																				   HORSE_NORTH_FRONT_RIGHT_LEG_PUFF_SHAPE,
																				   HORSE_NORTH_BACK_RIGHT_LEG_PUFF_SHAPE);
	
	protected static final VoxelShape HORSE_NORTH_LEG_MIDDLE_SHAPE = VoxelShapes.or(HORSE_NORTH_FRONT_LEFT_LEG_MIDDLE_SHAPE,
																					HORSE_NORTH_BACK_LEFT_LEG_MIDDLE_SHAPE,
																					HORSE_NORTH_FRONT_RIGHT_LEG_MIDDLE_SHAPE,
																					HORSE_NORTH_BACK_RIGHT_LEG_MIDDLE_SHAPE);
	
	protected static final VoxelShape HORSE_NORTH_HOOVES_SHAPE = VoxelShapes.or(HORSE_NORTH_FRONT_LEFT_HOOF_SHAPE,
																				HORSE_NORTH_BACK_LEFT_HOOF_SHAPE,
																				HORSE_NORTH_FRONT_RIGHT_HOOF_SHAPE,
																				HORSE_NORTH_BACK_RIGHT_HOOF_SHAPE);
	
	protected static final VoxelShape HORSE_NORTH_LEGS_SHAPE = VoxelShapes.or(HORSE_NORTH_LEG_PUFFS_SHAPE,
																			  HORSE_NORTH_LEG_MIDDLE_SHAPE,
																			  HORSE_NORTH_HOOVES_SHAPE);
	
	protected static final VoxelShape HORSE_NORTH_TAIL_SHAPE = VoxelShapes.or(HORSE_NORTH_TAIL1_SHAPE,
																			  HORSE_NORTH_TAIL2_SHAPE,
																			  HORSE_NORTH_TAIL3_SHAPE,
																			  HORSE_NORTH_TAIL4_SHAPE,
																			  HORSE_NORTH_TAIL5_SHAPE,
	...
	protected static final VoxelShape HORSE_NORTH_HEAD_SHAPE = VoxelShapes.or(HORSE_NORTH_HEAD_BACK1_SHAPE,
																			  HORSE_NORTH_HEAD_BACK2_SHAPE,
																			  HORSE_NORTH_HEAD_MIDDLE_SHAPE,
																			  HORSE_NORTH_HEAD_FRONT1_SHAPE,
	...
	protected static final VoxelShape HORSE_NORTH_MANE_SHAPE = VoxelShapes.or(HORSE_NORTH_MANE1_SHAPE,
																			  HORSE_NORTH_MANE2_SHAPE,
																			  HORSE_NORTH_MANE3_SHAPE,
																			  HORSE_NORTH_MANE4_SHAPE,
																			  HORSE_NORTH_MANE5_SHAPE);
	
	protected static final VoxelShape HORSE_NORTH_SHAPE = VoxelShapes.or(HORSE_NORTH_BODY_SHAPE,
																		 HORSE_NORTH_TAIL_SHAPE,
																		 HORSE_NORTH_NECK_SHAPE,
																		 HORSE_NORTH_MANE_SHAPE,
																		 HORSE_NORTH_HEAD_SHAPE,
																		 HORSE_NORTH_LEGS_SHAPE,
																		 HORSE_NORTH_EYES_SHAPE,
																		 HORSE_NORTH_EARS_SHAPE);
	...
	protected static final VoxelShape SKELETON_NORTH_SKULL_OUTSIDE_SHAPE = Block.makeCuboidShape(5.0D, 9.0D, 6.0D, 11.0D, 14.0D, 10.0D);
	protected static final VoxelShape SKELETON_NORTH_SKULL_INSIDE_SHAPE = Block.makeCuboidShape(6.0D, 8.0D, 7.0D, 10.0D, 13.0D, 9.0D);
	protected static final VoxelShape SKELETON_NORTH_SPINE_SHAPE = Block.makeCuboidShape(6.5D, 4.0D, 8.0D, 9.5D, 13.0D, 9.0D);
	protected static final VoxelShape SKELETON_NORTH_RIGHT_LEG_SHAPE = Block.makeCuboidShape(6.5D, 0.0D, 8.0D, 7.5D, 4.0D, 9.0D);
	protected static final VoxelShape SKELETON_NORTH_LEFT_LEG_SHAPE = Block.makeCuboidShape(8.5D, 0.0D, 8.0D, 9.5D, 4.0D, 9.0D);
	protected static final VoxelShape SKELETON_NORTH_RIB_TOP_SOLID_SHAPE = Block.makeCuboidShape(6.0D, 4.0D, 7.0D, 10.0D, 9.0D, 8.0D);
	protected static final VoxelShape SKELETON_NORTH_RIB_TOP_HOLE_SHAPE = Block.makeCuboidShape(7.0D, 8.0D, 7.0D, 9.0D, 9.0D, 8.0D);
	protected static final VoxelShape SKELETON_NORTH_RIB_BOTTOM_SOLID_SHAPE = Block.makeCuboidShape(6.5D, 3.0D, 7.0D, 9.5D, 4.0D, 8.0D);
	protected static final VoxelShape SKELETON_NORTH_RIB_BOTTOM_LEFT_HOLE_SHAPE = Block.makeCuboidShape(8.5D, 3.5D, 7.0D, 9.0D, 4.0D, 8.0D);
	protected static final VoxelShape SKELETON_NORTH_RIB_BOTTOM_RIGHT_HOLE_SHAPE = Block.makeCuboidShape(7.0D, 3.5D, 7.0D, 7.5D, 4.0D, 8.0D);
	protected static final VoxelShape SKELETON_NORTH_RIGHT_ARM_SHAPE = Block.makeCuboidShape(5.0D, 2.5D, 7.5D, 6.0D, 8.0D, 8.5D);
	protected static final VoxelShape SKELETON_NORTH_LEFT_ARM_SHAPE = Block.makeCuboidShape(10.0D, 2.5D, 7.5D, 11.0D, 8.0D, 8.5D);
	protected static final VoxelShape SKELETON_NORTH_BOW_SHAPE = Block.makeCuboidShape(9.5D, 2.5D, 4.5D, 10.5D, 6.5D, 11.5D);
	protected static final VoxelShape SKELETON_NORTH_RIGHT_EYE_SHAPE = Block.makeCuboidShape(6.0D, 12.0D, 5.5D, 7.0D, 13.0D, 6.0D);
	protected static final VoxelShape SKELETON_NORTH_LEFT_EYE_SHAPE = Block.makeCuboidShape(9.0D, 12.0D, 5.5D, 10.0D, 13.0D, 6.0D);
	protected static final VoxelShape SKELETON_NORTH_MOUTH_TOP_SHAPE = Block.makeCuboidShape(7.0D, 11.0D, 5.5D, 9.0D, 12.0D, 6.0D);
	protected static final VoxelShape SKELETON_NORTH_MOUTH_BOTTOM_SHAPE = Block.makeCuboidShape(6.0D, 10.0D, 5.5D, 10.0D, 11.0D, 6.0D);
	
	protected static final VoxelShape SKELETON_NORTH_SKULL_SHAPE = VePlushBlock.cutShape(SKELETON_NORTH_SKULL_OUTSIDE_SHAPE,
																						 SKELETON_NORTH_SKULL_INSIDE_SHAPE);
	
	protected static final VoxelShape SKELETON_NORTH_RIB_TOP_SHAPE = VePlushBlock.cutShape(SKELETON_NORTH_RIB_TOP_SOLID_SHAPE,
																						   SKELETON_NORTH_RIB_TOP_HOLE_SHAPE);
	
	protected static final VoxelShape SKELETON_NORTH_RIB_BOTTOM_SHAPE = VePlushBlock.cutShape(SKELETON_NORTH_RIB_BOTTOM_SOLID_SHAPE,
																							  SKELETON_NORTH_RIB_BOTTOM_LEFT_HOLE_SHAPE,
	...
	protected static final VoxelShape SKELETON_NORTH_SHAPE = VoxelShapes.or(SKELETON_NORTH_SPINE_SHAPE,
																			SKELETON_NORTH_SKULL_SHAPE,
																			SKELETON_NORTH_RIB_TOP_SHAPE,
																			SKELETON_NORTH_RIB_BOTTOM_SHAPE,
																			SKELETON_NORTH_LEGS_SHAPE,
																			SKELETON_NORTH_ARMS_SHAPE,
																			SKELETON_NORTH_BOW_SHAPE,
																			SKELETON_NORTH_EYES_SHAPE,
	...
	protected static final VoxelShape BAT_NORTH_EYES_AND_MOUTH_SHAPE = VoxelShapes.or(BAT_NORTH_RIGHT_EYE_SHAPE,
																					  BAT_NORTH_LEFT_EYE_SHAPE,
																					  BAT_NORTH_MOUTH_SHAPE);
	...
	protected static final VoxelShape BAT_NORTH_LEFT_WING_SHAPE = VoxelShapes.or(BAT_NORTH_LEFT_WING1_SHAPE,
																				 BAT_NORTH_LEFT_WING2_SHAPE,
																				 BAT_NORTH_LEFT_WING3_SHAPE,
																				 BAT_NORTH_LEFT_WING4_SHAPE);
	
	protected static final VoxelShape BAT_NORTH_RIGHT_WING_SHAPE = VoxelShapes.or(BAT_NORTH_RIGHT_WING1_SHAPE,
																				  BAT_NORTH_RIGHT_WING2_SHAPE,
																				  BAT_NORTH_RIGHT_WING3_SHAPE,
																				  BAT_NORTH_RIGHT_WING4_SHAPE,
																				  BAT_NORTH_RIGHT_WING5_SHAPE);
	
	protected static final VoxelShape BAT_NORTH_SHAPE = VoxelShapes.or(BAT_NORTH_BODY_SHAPE,
																	   BAT_NORTH_HEAD_SHAPE,
																	   BAT_NORTH_EARS_SHAPE,
																	   BAT_NORTH_EYES_AND_MOUTH_SHAPE,
																	   BAT_NORTH_LEGS_SHAPE,
																	   BAT_NORTH_LEFT_WING_SHAPE,
	...
	protected static final VoxelShape BEE_NORTH_RIGHT_MAIN_WING_SHAPE = VePlushBlock.cutShape(BEE_NORTH_RIGHT_WING_MAIN_OUTSIDE_SHAPE,
																							  BEE_NORTH_RIGHT_WING_MAIN_INSIDE_SHAPE);
	
	protected static final VoxelShape BEE_NORTH_LEFT_MAIN_WING_SHAPE = VePlushBlock.cutShape(BEE_NORTH_LEFT_WING_MAIN_OUTSIDE_SHAPE,
																							 BEE_NORTH_LEFT_WING_MAIN_INSIDE_SHAPE);
	...
	protected static final VoxelShape BEE_NORTH_ANTENNAS_SHAPE = VoxelShapes.or(BEE_NORTH_RIGHT_ANTENNA_BOTTOM_SHAPE,
																				BEE_NORTH_RIGHT_ANTENNA_TOP_SHAPE,
																				BEE_NORTH_LEFT_ANTENNA_BOTTOM_SHAPE,
																				BEE_NORTH_LEFT_ANTENNA_TOP_SHAPE);
	
	protected static final VoxelShape BEE_NORTH_RIGHT_LEGS_SHAPE = VoxelShapes.or(BEE_NORTH_FRONT_MAIN_RIGHT_LEG_SHAPE,
																				  BEE_NORTH_FRONT_BEND_RIGHT_LEG_SHAPE,
																				  BEE_NORTH_MIDDLE_FRONT_RIGHT_LEG_SHAPE,
																				  BEE_NORTH_MIDDLE_BACK_RIGHT_LEG_SHAPE,
																				  BEE_NORTH_BACK_MAIN_RIGHT_LEG_SHAPE,
	...
	protected static final VoxelShape BEE_NORTH_LEFT_LEGS_SHAPE = VoxelShapes.or(BEE_NORTH_FRONT_MAIN_LEFT_LEG_SHAPE,
																				 BEE_NORTH_FRONT_BEND_LEFT_LEG_SHAPE,
																				 BEE_NORTH_MIDDLE_FRONT_LEFT_LEG_SHAPE,
																				 BEE_NORTH_MIDDLE_BACK_LEFT_LEG_SHAPE,
																				 BEE_NORTH_BACK_MAIN_LEFT_LEG_SHAPE,
	...
	protected static final VoxelShape BEE_NORTH_SHAPE = VoxelShapes.or(BEE_NORTH_BODY_SHAPE,
																	   BEE_NORTH_STINGER_SHAPE,
																	   BEE_NORTH_EYES_SHAPE,
																	   BEE_NORTH_ANTENNAS_SHAPE,
																	   BEE_NORTH_RIGHT_LEGS_SHAPE,
																	   BEE_NORTH_LEFT_LEGS_SHAPE,
																	   BEE_NORTH_RIGHT_WING_SHAPE,
																	   BEE_NORTH_LEFT_WING_SHAPE);
	...
	protected static final VoxelShape SILVERFISH_NORTH_BODY_SHAPE = VoxelShapes.or(SILVERFISH_NORTH_HEAD_BODY_SHAPE,
																				   SILVERFISH_NORTH_FRONT_BODY_SHAPE,
																				   SILVERFISH_NORTH_MIDDLE_BODY_SHAPE,
																				   SILVERFISH_NORTH_BACK1_BODY_SHAPE,
																				   SILVERFISH_NORTH_BACK2_BODY_SHAPE,
																				   SILVERFISH_NORTH_TAIL_SHAPE);
	
	protected static final VoxelShape SILVERFISH_NORTH_FRONT_TUFFS_SHAPE = VoxelShapes.or(SILVERFISH_NORTH_FRONT_TOP_TUFF_BOTTOM_SHAPE,
																						  SILVERFISH_NORTH_FRONT_TOP_TUFF_TOP_SHAPE,
																						  SILVERFISH_NORTH_FRONT_RIGHT_TUFF_BOTTOM_SHAPE,
																						  SILVERFISH_NORTH_FRONT_RIGHT_TUFF_TOP_SHAPE,
																						  SILVERFISH_NORTH_FRONT_LEFT_TUFF_BOTTOM_SHAPE,
																						  SILVERFISH_NORTH_FRONT_LEFT_TUFF_TOP_SHAPE);
	...
	protected static final VoxelShape SILVERFISH_NORTH_MIDDLE_TUFFS_SHAPE = VoxelShapes.or(SILVERFISH_NORTH_MIDDLE_FRONT_TOP_BOTTOM_LEFT_TUFF_SHAPE,
																						   ...
																						   SILVERFISH_NORTH_MIDDLE_FRONT_TOP_RIGHT_TUFF_SHAPE,
																						   SILVERFISH_NORTH_MIDDLE_FRONT_TOP_BOTTOM_TUFF_SHAPE,
																						   SILVERFISH_NORTH_MIDDLE_FRONT_TOP_TOP_TUFF_SHAPE,
																						   SILVERFISH_NORTH_MIDDLE_BACK_LEFT_TUFF_BOTTOM_SHAPE,
																						   SILVERFISH_NORTH_MIDDLE_BACK_LEFT_TUFF_TOP_BOTTOM_SHAPE,
																						   SILVERFISH_NORTH_MIDDLE_BACK_LEFT_TUFF_TOP_TOP_SHAPE,
																						   SILVERFISH_NORTH_MIDDLE_BACK_RIGHT_TUFF_BOTTOM_SHAPE,
	...
	protected static final VoxelShape SILVERFISH_NORTH_BACK2_TUFFS_SHAPE = VoxelShapes.or(SILVERFISH_NORTH_BACK2_LEFT_SHAPE,
																						  SILVERFISH_NORTH_BACK2_RIGHT_BOTTOM_SHAPE,
																						  SILVERFISH_NORTH_BACK2_RIGHT_TOP1_SHAPE,
																						  SILVERFISH_NORTH_BACK2_RIGHT_TOP2_SHAPE);
	
	protected static final VoxelShape SILVERFISH_NORTH_SHAPE = VoxelShapes.or(SILVERFISH_NORTH_BODY_SHAPE,
																			  SILVERFISH_NORTH_FRONT_TUFFS_SHAPE,
																			  SILVERFISH_NORTH_MIDDLE_TUFFS_SHAPE,
	...
	protected static final VoxelShape VILLAGER_NORTH_ARM_SHAPE = VoxelShapes.or(VILLAGER_NORTH_ARM_MIDDLE_SHAPE,
																				VILLAGER_NORTH_RIGHT_ARM_SHAPE,
																				VILLAGER_NORTH_LEFT_ARM_SHAPE);
	
	protected static final VoxelShape VILLAGER_NORTH_FACE_SHAPE = VoxelShapes.or(VILLAGER_NORTH_NOSE_SHAPE,
																				 VILLAGER_NORTH_MOUTH_SHAPE,
																				 VILLAGER_NORTH_RIGHT_EYE_SHAPE,
																				 VILLAGER_NORTH_LEFT_EYE_SHAPE,
	...
	protected static final VoxelShape VILLAGER_NORTH_BODY_SHAPE = VoxelShapes.or(VILLAGER_NORTH_HEAD_SHAPE,
																				 VILLAGER_NORTH_TORSO_SHAPE,
																				 VILLAGER_NORTH_ARM_SHAPE,
																				 VILLAGER_NORTH_FACE_SHAPE);
	...
	protected static final VoxelShape PLAINS_VILLAGER_NORTH_COAT_SHAPE = VePlushBlock.cutShape(PLAINS_VILLAGER_NORTH_COAT_BASE_SHAPE,
																							   PLAINS_VILLAGER_NORTH_COAT_NECK1_SHAPE,
																							   PLAINS_VILLAGER_NORTH_COAT_NECK2_SHAPE,
																							   PLAINS_VILLAGER_NORTH_COAT_OPENING_SHAPE);
	...
	protected static final VoxelShape DESERT_VILLAGER_NORTH_COAT_SHAPE = VePlushBlock.cutShape(PLAINS_VILLAGER_NORTH_COAT_SHAPE,
																							   DESERT_VILLAGER_NORTH_COAT_RIP1_SHAPE,
																							   DESERT_VILLAGER_NORTH_COAT_RIP2_SHAPE,
																							   DESERT_VILLAGER_NORTH_COAT_RIP3_SHAPE);
	
	protected static final VoxelShape DESERT_VILLAGER_NORTH_HAT_SHAPE = VoxelShapes.or(DESERT_VILLAGER_NORTH_HAT_COTTEN_PUFF_SHAPE,
																					   DESERT_VILLAGER_NORTH_HAT_MIDDLE_SHAPE,
	...
	protected static final VoxelShape DESERT_VILLAGER_NORTH_SHAPE = VoxelShapes.or(VILLAGER_NORTH_BODY_SHAPE,
																				   DESERT_VILLAGER_NORTH_COAT_SHAPE,
																				   DESERT_VILLAGER_NORTH_HAT_SHAPE);
	...
	protected static final VoxelShape JUNGLE_VILLAGER_NORTH_COAT_SHAPE = VePlushBlock.cutShape(JUNGLE_VILLAGER_NORTH_COAT_BASE_SHAPE,
																							   PLAINS_VILLAGER_NORTH_COAT_NECK1_SHAPE,
																							   PLAINS_VILLAGER_NORTH_COAT_NECK2_SHAPE,
																							   JUNGLE_VILLAGER_NORTH_LEFT_HOLE_SHAPE,
																							   JUNGLE_VILLAGER_NORTH_FRONT_HOLE1_SHAPE,
																							   JUNGLE_VILLAGER_NORTH_FRONT_HOLE2_SHAPE,
																							   JUNGLE_VILLAGER_NORTH_FRONT_HOLE3_SHAPE,
																							   JUNGLE_VILLAGER_NORTH_FRONT_HOLE4_SHAPE,
																							   JUNGLE_VILLAGER_NORTH_FRONT_HOLE5_SHAPE,
																							   JUNGLE_VILLAGER_NORTH_FRONT_HOLE6_SHAPE,
																							   JUNGLE_VILLAGER_NORTH_BACK_HOLE1_SHAPE,
																							   JUNGLE_VILLAGER_NORTH_BACK_HOLE2_SHAPE,
																							   JUNGLE_VILLAGER_NORTH_BACK_HOLE3_SHAPE,
																							   JUNGLE_VILLAGER_NORTH_BACK_HOLE4_SHAPE);
	
	protected static final VoxelShape JUNGLE_VILLAGER_NORTH_VINE_BELT_BOTTOM_SHAPE = VePlushBlock.cutShape(JUNGLE_VILLAGER_NORTH_VINE_BELT_BOTTOM_BASE_SHAPE,
																										   JUNGLE_VILLAGER_NORTH_VINE_BELT_BOTTOM_HOLE_SHAPE);
	
	protected static final VoxelShape JUNGLE_VILLAGER_NORTH_VINE_BELT_SHAPE = VoxelShapes.or(JUNGLE_VILLAGER_NORTH_VINE_BELT_BOTTOM_SHAPE,
																							 JUNGLE_VILLAGER_NORTH_VINE_BELT_TOP_SHAPE);
	
	protected static final VoxelShape JUNGLE_VILLAGER_NORTH_SHAPE = VoxelShapes.or(VILLAGER_NORTH_BODY_SHAPE,
																				   JUNGLE_VILLAGER_NORTH_VINE_BELT_SHAPE,
																				   JUNGLE_VILLAGER_NORTH_COAT_SHAPE);
	...
	protected static final VoxelShape SAVANNA_VILLAGER_NORTH_SHAPE = VoxelShapes.or(VILLAGER_NORTH_BODY_SHAPE,
																					PLAINS_VILLAGER_NORTH_COAT_BASE_SHAPE,
																					SAVANNA_VILLAGER_NORTH_HEAD_BAND_SHAPE,
	...
	protected static final VoxelShape SNOW_VILLAGER_NORTH_SWEATER_SHAPE = VePlushBlock.cutShape(SNOW_VILLAGER_NORTH_SWEATER_BASE_SHAPE,
																								SNOW_VILLAGER_NORTH_SWEATER_NECK1_SHAPE,
																								SNOW_VILLAGER_NORTH_SWEATER_NECK2_SHAPE,
																								SNOW_VILLAGER_NORTH_SWEATER_HOLE_FRONT_BOTTOM_SHAPE,
	...
	protected static final VoxelShape SNOW_VILLAGER_NORTH_SHAPE = VoxelShapes.or(VILLAGER_NORTH_BODY_SHAPE,
																				 SNOW_VILLAGER_NORTH_SWEATER_SHAPE,
																				 SNOW_VILLAGER_NORTH_HAT_SHAPE);
	...
	protected static final VoxelShape SWAMP_VILLAGER_NORTH_HAT_SHAPE = VoxelShapes.or(SWAMP_VILLAGER_NORTH_HAT_TOP_SHAPE,
																					  SWAMP_VILLAGER_NORTH_HAT_SIDES_SHAPE,
																					  SWAMP_VILLAGER_NORTH_HAT_BACK_SHAPE);
	
	protected static final VoxelShape SWAMP_VILLAGER_NORTH_APRON_SHAPE = VoxelShapes.or(SWAMP_VILLAGER_NORTH_APRON_MAIN_SHAPE,
																						SWAMP_VILLAGER_NORTH_APRON_BAND_SHAPE,
	...
	protected static final VoxelShape SWAMP_VILLAGER_NORTH_SHAPE = VoxelShapes.or(VILLAGER_NORTH_BODY_SHAPE,
																				  SWAMP_VILLAGER_NORTH_HAT_SHAPE,
																				  SWAMP_VILLAGER_NORTH_APRON_SHAPE,
																				  PLAINS_VILLAGER_NORTH_COAT_SHAPE);
	...
	protected static final VoxelShape TAIGA_VILLAGER_NORTH_COAT_SHAPE = VePlushBlock.cutShape(PLAINS_VILLAGER_NORTH_COAT_BASE_SHAPE,
																							  SNOW_VILLAGER_NORTH_SWEATER_NECK1_SHAPE,
																							  SNOW_VILLAGER_NORTH_SWEATER_NECK2_SHAPE,
																							  TAIGA_VILLAGER_NORTH_COAT_NECK3_SHAPE,
																							  TAIGA_VILLAGER_NORTH_COAT_BOTTOM1_SHAPE,
																							  TAIGA_VILLAGER_NORTH_COAT_BOTTOM2_SHAPE);
	
	protected static final VoxelShape TAIGA_VILLAGER_NORTH_BELT_SHAPE = VoxelShapes.or(TAIGA_VILLAGER_NORTH_BELT_STRAP_SHAPE,
																					   TAIGA_VILLAGER_NORTH_BELT_BUCKLE_SHAPE);
	
	protected static final VoxelShape TAIGA_VILLAGER_NORTH_SHAPE = VoxelShapes.or(VILLAGER_NORTH_BODY_SHAPE,
																				  TAIGA_VILLAGER_NORTH_COAT_SHAPE,
																				  TAIGA_VILLAGER_NORTH_BELT_SHAPE);
	...
	protected static final VoxelShape GUARDIAN_NORTH_BODY3_SHAPE = VePlushBlock.cutShape(GUARDIAN_NORTH_BODY3_SOLID_SHAPE,
																						 GUARDIAN_NORTH_EYE_HOLE_SHAPE);
	
	protected static final VoxelShape GUARDIAN_NORTH_HORNS_SHAPE = VoxelShapes.or(GUARDIAN_NORTH_LEFT_HORN1_SHAPE,
																				  GUARDIAN_NORTH_LEFT_HORN2_SHAPE,
																				  GUARDIAN_NORTH_RIGHT_HORN1_SHAPE,
																				  GUARDIAN_NORTH_RIGHT_HORN2_SHAPE,
																				  GUARDIAN_NORTH_FRONT_HORN1_SHAPE,
																				  GUARDIAN_NORTH_FRONT_HORN2_SHAPE,
																				  GUARDIAN_NORTH_BACK_HORN1_SHAPE,
																				  GUARDIAN_NORTH_BACK_HORN2_SHAPE,
																				  GUARDIAN_NORTH_LEFT_BOTTOM_HORN_SHAPE,
																				  GUARDIAN_NORTH_RIGHT_BOTTOM_HORN_SHAPE,
																				  GUARDIAN_NORTH_FRONT_BOTTOM_HORN_SHAPE,
	...
	protected static final VoxelShape GUARDIAN_NORTH_SHAPE = VoxelShapes.or(GUARDIAN_NORTH_BODY_SHAPE,
																			GUARDIAN_NORTH_HORNS_SHAPE,
																			GUARDIAN_NORTH_TAIL_SHAPE,
																			GUARDIAN_NORTH_TAIL_TIP_SHAPE,
	...
	protected static final VoxelShape WITCH_NORTH_HEAD_AND_HAT_SHAPE = VoxelShapes.or(WITCH_NORTH_HEAD_AND_HAT_MIDDLE_SHAPE,
																					  WITCH_NORTH_HAT_TOP_SHAPE,
																					  WITCH_NORTH_HAT_BRIM_SHAPE,
																					  WITCH_NORTH_HAT_STRAP_SHAPE,
																					  WITCH_NORTH_HAT_STRAP_ACCENT_SHAPE);
	
	protected static final VoxelShape WITCH_NORTH_FACE_SHAPE = VoxelShapes.or(WITCH_NORTH_EYEBROW_SHAPE,
																			  WITCH_NORTH_RIGHT_EYE_SHAPE,
																			  WITCH_NORTH_LEFT_EYE_SHAPE,
																			  WITCH_NORTH_NOSE_SHAPE,
	...
	protected static final VoxelShape WITCH_NORTH_NECKTIE_SHAPE = VoxelShapes.or(WITCH_NORTH_NECKTIE_MIDDLE_SHAPE,
																				 WITCH_NORTH_NECKTIE_STRAP_MIDDLE_SHAPE,
																				 WITCH_NORTH_NECKTIE_STRAP_RIGHT_SHAPE,
	...
	protected static final VoxelShape WITCH_NORTH_ARMS_SHAPE = VoxelShapes.or(WITCH_NORTH_MIDDLE_ARM_SHAPE,
																			  WITCH_NORTH_RIGHT_ARM_SHAPE,
																			  WITCH_NORTH_LEFT_ARM_SHAPE);
	
	protected static final VoxelShape WITCH_NORTH_SHAPE = VoxelShapes.or(WITCH_NORTH_TORSO_SHAPE,
																		 WITCH_NORTH_FEET_SHAPE,
																		 WITCH_NORTH_HEAD_AND_HAT_SHAPE,
																		 WITCH_NORTH_FACE_SHAPE,
																		 WITCH_NORTH_NECKTIE_SHAPE,
	...
	protected static final VoxelShape RABBIT_NORTH_LEGS_SHAPE = VoxelShapes.or(RABBIT_NORTH_BACK_RIGHT_ANKLE_SHAPE,
																			   RABBIT_NORTH_BACK_LEFT_ANKLE_SHAPE,
																			   RABBIT_NORTH_BACK_RIGHT_LEG_SHAPE,
																			   RABBIT_NORTH_BACK_LEFT_LEG_SHAPE,
																			   RABBIT_NORTH_FRONT_RIGHT_LEG_SHAPE,
																			   RABBIT_NORTH_FRONT_LEFT_LEG_SHAPE);
	
	protected static final VoxelShape RABBIT_NORTH_SHAPE = VoxelShapes.or(RABBIT_NORTH_HEAD_SHAPE,
																		  RABBIT_NORTH_BODY_SHAPE,
																		  RABBIT_NORTH_TAIL_SHAPE,
																		  RABBIT_NORTH_NOSE_SHAPE,
																		  RABBIT_NORTH_EARS_SHAPE,
																		  RABBIT_NORTH_EYES_SHAPE,
																		  RABBIT_NORTH_LEGS_SHAPE);
	...
	public VoxelShape getShape(BlockState state, IBlockReader worldIn, BlockPos pos, ISelectionContext context)
	{
		...
		else if(this == VeBlocks.white_sheep_plush      ||
				this == VeBlocks.orange_sheep_plush     ||
				this == VeBlocks.magenta_sheep_plush    ||
				this == VeBlocks.light_blue_sheep_plush ||
				this == VeBlocks.yellow_sheep_plush     ||
				this == VeBlocks.lime_sheep_plush       ||
				this == VeBlocks.pink_sheep_plush       ||
				this == VeBlocks.gray_sheep_plush       ||
				this == VeBlocks.light_gray_sheep_plush ||
				this == VeBlocks.cyan_sheep_plush       ||
				this == VeBlocks.purple_sheep_plush     ||
				this == VeBlocks.blue_sheep_plush       ||
				this == VeBlocks.brown_sheep_plush      ||
				this == VeBlocks.green_sheep_plush      ||
				this == VeBlocks.red_sheep_plush        ||
				this == VeBlocks.black_sheep_plush)
		{
		...
		else if(this == VeBlocks.baby_red_mooshroom_plush || this == VeBlocks.baby_brown_mooshroom_plush)
		{
			return VePlushBlock.defineShapes(state, BABY_MOOSHROOM_NORTH_SHAPE, BABY_MOOSHROOM_SOUTH_SHAPE, BABY_MOOSHROOM_WEST_SHAPE, BABY_MOOSHROOM_EAST_SHAPE);
				...
				this == VeBlocks.tabby_cat_plush             ||
				this == VeBlocks.tuxedo_cat_plush            ||
				this == VeBlocks.red_cat_plush               ||
				this == VeBlocks.siamese_cat_plush           ||
				this == VeBlocks.british_shorthair_cat_plush ||
				this == VeBlocks.calico_cat_plush            ||
				this == VeBlocks.ragdoll_cat_plush           ||
				this == VeBlocks.white_cat_plush             ||
				this == VeBlocks.jellie_cat_plush            ||
		...
		else if(this == VeBlocks.spider_plush)
		{
			return VePlushBlock.defineShapes(state, SPIDER_NORTH_SHAPE, SPIDER_SOUTH_SHAPE, SPIDER_WEST_SHAPE, SPIDER_EAST_SHAPE);
				...
				this == VeBlocks.black_horse_plush      ||
				this == VeBlocks.purple_horse_plush)
		{
	...
	/**
	 * Use the second parameter's shapes to cut smaller shapes into the first parameter's shape and return the new shape
	 */
