...
public class VePlantingPotBlock extends Block implements IWaterLoggable
{
    ...
    protected static final VoxelShape TOP_SHAPE = VoxelShapes.combineAndSimplify(TOP_OUTSIDE_SHAPE, TOP_INSIDE_SHAPE,
            IBooleanFunction.ONLY_FIRST);

    private static final VoxelShape PILLARS_SHAPE = VoxelShapes.or(PILLAR_1_SHAPE, PILLAR_2_SHAPE, PILLAR_3_SHAPE,
            PILLAR_4_SHAPE);
    private static final VoxelShape PLANTING_POT_SHAPE = VoxelShapes.or(TOP_SHAPE, PILLARS_SHAPE, LIQUID_SHAPE,
            BASE_SHAPE);
    ...
    {
        return VeBlockTags.NETHER_PLANTABLE.func_230235_a_(this.getBlock())
                && VeBlockTags.NETHER_POTTABLE.func_230235_a_(plantBlock)
                || VeBlockTags.OVERWORLD_PLANTABLE.func_230235_a_(this.getBlock())
                        && VeBlockTags.OVERWORLD_POTTABLE.func_230235_a_(plantBlock)
                || VeBlockTags.END_PLANTABLE.func_230235_a_(this.getBlock())
                        && VeBlockTags.END_POTTABLE.func_230235_a_(plantBlock);
    }
