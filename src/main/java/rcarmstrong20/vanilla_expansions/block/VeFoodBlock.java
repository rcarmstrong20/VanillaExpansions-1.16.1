...
public class VeFoodBlock extends CakeBlock
{
	...
	/**
	 * If the block can be eaten add the appropriate hunger and when it has one slice left remove it from the world.
	 * 
	 * @param world  This world.
	 * @param pos    The block's position.
	 * @param state  The state for this block.
	 * @param player The player eating the block.
	 * @return       Whether the block was eaten ActionResultType.SUCCESS or ActionResultType.PASS.
	 */
