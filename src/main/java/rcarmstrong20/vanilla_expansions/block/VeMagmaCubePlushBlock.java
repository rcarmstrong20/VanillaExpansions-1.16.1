...
public class VeMagmaCubePlushBlock extends VeTallPlushBlock
{
    ...
    protected static final VoxelShape BOTTOM_BODY_SHAPE = Block.makeCuboidShape(3.0D, 0.0D, 3.0D, 13.0D, 10.0D, 13.0D);
    protected static final VoxelShape BOTTOM_NORTH_LEFT_EYE_SHAPE = Block.makeCuboidShape(10.0D, 5.0D, 3.0D, 12.0D,
            7.0D, 2.5D);
    protected static final VoxelShape BOTTOM_NORTH_RIGHT_EYE_SHAPE = Block.makeCuboidShape(4.0D, 5.0D, 3.0D, 6.0D, 7.0D,
            2.5D);
    ...
    protected static final VoxelShape MIDDLE_BODY_SHAPE = Block.makeCuboidShape(4.0D, 8.0D, 4.0D, 12.0D, 17.0D, 12.0D);
    protected static final VoxelShape MIDDLE_NORTH_LEFT_EYE_SHAPE = Block.makeCuboidShape(9.0D, 14.0D, 4.0D, 10.5D,
            15.5D, 3.5D);
    protected static final VoxelShape MIDDLE_NORTH_RIGHT_EYE_SHAPE = Block.makeCuboidShape(5.0D, 14.0D, 4.0D, 6.5D,
            15.5D, 3.5D);
    ...
    protected static final VoxelShape TOP_BODY_SHAPE = Block.makeCuboidShape(6.0D, 1.0D, 6.0D, 10.0D, 5.0D, 10.0D);
    protected static final VoxelShape TOP_NORTH_LEFT_EYE_SHAPE = Block.makeCuboidShape(6.5D, 3.0D, 6.0D, 7.5D, 4.0D,
            5.5D);
    protected static final VoxelShape TOP_NORTH_RIGHT_EYE_SHAPE = Block.makeCuboidShape(8.5D, 3.0D, 6.0D, 9.5D, 4.0D,
            5.5D);
