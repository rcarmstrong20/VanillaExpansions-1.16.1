...
public class VEWolfPlushBlock extends VEPlushBlock
{
    ...
    protected static final VoxelShape WOLF_NORTH_SNOUT_SHAPE = Block.box(6.0D, 2.0D, 0.5D, 10.0D, 5.5D, 4.0D);
    protected static final VoxelShape WOLF_NORTH_FRONT_RIGHT_LEG_SHAPE = Block.box(8.5D, 0.0D, 9.0D, 9.5D, 2.0D, 10.0D);
    protected static final VoxelShape WOLF_NORTH_FRONT_LEFT_LEG_SHAPE = Block.box(6.5D, 0.0D, 9.0D, 7.5D, 2.0D, 10.0D);
    protected static final VoxelShape WOLF_NORTH_BACK_RIGHT_LEG_SHAPE = Block.box(8.5D, 0.0D, 11.5D, 9.5D, 2.0D, 12.5D);
    protected static final VoxelShape WOLF_NORTH_BACK_LEFT_LEG_SHAPE = Block.box(6.5D, 0.0D, 11.5D, 7.5D, 2.0D, 12.5D);
    protected static final VoxelShape WOLF_NORTH_RIGHT_EYE_SHAPE = Block.box(5.5D, 6.0D, 3.5D, 7.5D, 7.0D, 4.0D);
    protected static final VoxelShape WOLF_NORTH_LEFT_EYE_SHAPE = Block.box(8.5D, 6.0D, 3.5D, 10.5D, 7.0D, 4.0D);
    protected static final VoxelShape WOLF_NORTH_RIGHT_EAR_SHAPE = Block.box(9.0D, 8.5D, 6.0D, 10.5D, 10.5D, 7.0D);
    protected static final VoxelShape WOLF_NORTH_LEFT_EAR_SHAPE = Block.box(5.5D, 8.5D, 6.0D, 7.0D, 10.5D, 7.0D);
    protected static final VoxelShape WOLF_NORTH_TAIL1_SHAPE = Block.box(7.0D, 3.0D, 13.0D, 9.0D, 6.0D, 14.0D);
    protected static final VoxelShape WOLF_NORTH_TAIL2_SHAPE = Block.box(7.0D, 2.0D, 14.0D, 9.0D, 5.0D, 16.0D);
